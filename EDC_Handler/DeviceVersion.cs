...
// Type: EDC_Handler.DeviceVersion
...
namespace EDC_Handler
{
  public sealed class DeviceVersion
  {
    ...
    public EDC_Hardware Type
    {
      get
      {
        return Enum.IsDefined(typeof (EDC_Hardware), (object) this.TypeValue) ? (EDC_Hardware) Enum.ToObject(typeof (EDC_Hardware), this.TypeValue) : EDC_Hardware.Unknown;
      }
    }
