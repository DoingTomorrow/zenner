...
namespace EDC_Handler
{
  public class LoggerEditor : Form
  {
    ...
    private TextBox txtNextIndexStichtag;
    private TextBox txtNextIndexFullmonth;
    private TextBox txtNextIndexHalfmonth;
    ...
    private DataGridView tableValues;
    ...
    private void tabs_Selected(object sender, TabControlEventArgs e)
    {
      ...
      if (handlerMeter == null)
      {
        ...
        this.txtNextIndexFullmonth.Text = string.Empty;
        this.txtNextIndexHalfmonth.Text = string.Empty;
        this.txtNextIndexStichtag.Text = string.Empty;
      ...
      else
      {
        ...
        if (e.TabPage == this.tabValues && e.Action == TabControlAction.Selected)
          this.tableValues.DataSource = (object) ValueIdent.ToDataTable(this.MyFunctions.GetValues());
        else if (e.TabPage == this.tabFlashLogger && e.Action == TabControlAction.Selected)
        {
          DataTable flashLoggerDataTable = LoggerManager.CreateFlashLoggerDataTable(handlerMeter);
          if (flashLoggerDataTable == null)
            return;
          Addresses addresses = Addresses.Get(handlerMeter);
          if (addresses == null)
            return;
          this.txtLOG_ADDRESS_HALFMONTH_START.Text = string.Format("0x{0:X4}", (object) addresses.LOG_ADDRESS_HALFMONTH_START);
          this.txtLOG_ADDRESS_FULLMONTH_START.Text = string.Format("0x{0:X4}", (object) addresses.LOG_ADDRESS_FULLMONTH_START);
          this.txtLOG_ADDRESS_STICHTAG_START.Text = string.Format("0x{0:X4}", (object) addresses.LOG_ADDRESS_STICHTAG_START);
          this.txtLog_fullmonth_address.Text = string.Format("0x{0:X4}", (object) addresses.log_fullmonth_address);
          this.txtLog_halfmonth_address.Text = string.Format("0x{0:X4}", (object) addresses.log_halfmonth_address);
          this.txtLog_stichtag_address.Text = string.Format("0x{0:X4}", (object) addresses.log_stichtag_address);
          TextBox nextIndexFullmonth = this.txtNextIndexFullmonth;
          int num = addresses.NextIndexFullmonth;
          string str1 = num.ToString();
          nextIndexFullmonth.Text = str1;
          TextBox nextIndexHalfmonth = this.txtNextIndexHalfmonth;
          num = addresses.NextIndexHalfmonth;
          string str2 = num.ToString();
          nextIndexHalfmonth.Text = str2;
          TextBox nextIndexStichtag = this.txtNextIndexStichtag;
          num = addresses.NextIndexStichtag;
          string str3 = num.ToString();
          nextIndexStichtag.Text = str3;
          ...
          this.tableFlashDataLogger.DataSource = (object) flashLoggerDataTable;
        }
        else
        {
          ...
          this.cboxRamLoggerType.DataSource = (object) Util.GetNamesOfEnum(typeof (RamLoggerType));
          this.cboxRamLoggerType.SelectedItem = (object) RamLoggerType.QuarterHour.ToString();
          this.cboxRamHeaderFlags.DataSource = (object) Util.GetNamesOfEnum(typeof (RamLoggerFifoType));
        }
      }
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.txtNextIndexStichtag = new TextBox();
      this.txtNextIndexFullmonth = new TextBox();
      this.txtNextIndexHalfmonth = new TextBox();
      ...
      this.tableValues = new DataGridView();
      ...
      ((ISupportInitialize) this.tableValues).BeginInit();
      this.SuspendLayout();
      ...
      this.tabFlashLogger.Controls.Add((Control) this.label10);
      this.tabFlashLogger.Controls.Add((Control) this.label9);
      this.tabFlashLogger.Controls.Add((Control) this.label8);
      this.tabFlashLogger.Controls.Add((Control) this.txtNextIndexStichtag);
      this.tabFlashLogger.Controls.Add((Control) this.txtNextIndexFullmonth);
      this.tabFlashLogger.Controls.Add((Control) this.txtNextIndexHalfmonth);
      ...
      this.label10.Location = new Point(459, 403);
      this.label10.Name = "label10";
      this.label10.Size = new Size(64, 17);
      this.label10.TabIndex = 44;
      this.label10.Text = "Next index:";
      this.label10.TextAlign = ContentAlignment.TopRight;
      this.label9.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
      this.label9.Location = new Point(459, 424);
      this.label9.Name = "label9";
      this.label9.Size = new Size(64, 17);
      this.label9.TabIndex = 43;
      this.label9.Text = "Next index:";
      this.label9.TextAlign = ContentAlignment.TopRight;
      this.label8.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
      this.label8.Location = new Point(459, 381);
      this.label8.Name = "label8";
      this.label8.Size = new Size(64, 17);
      this.label8.TabIndex = 42;
      this.label8.Text = "Next index:";
      this.label8.TextAlign = ContentAlignment.TopRight;
      this.txtNextIndexStichtag.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
      this.txtNextIndexStichtag.Location = new Point(525, 421);
      this.txtNextIndexStichtag.Name = "txtNextIndexStichtag";
      this.txtNextIndexStichtag.ReadOnly = true;
      this.txtNextIndexStichtag.Size = new Size(39, 20);
      this.txtNextIndexStichtag.TabIndex = 41;
      this.txtNextIndexFullmonth.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
      this.txtNextIndexFullmonth.Location = new Point(525, 399);
      this.txtNextIndexFullmonth.Name = "txtNextIndexFullmonth";
      this.txtNextIndexFullmonth.ReadOnly = true;
      this.txtNextIndexFullmonth.Size = new Size(39, 20);
      this.txtNextIndexFullmonth.TabIndex = 40;
      this.txtNextIndexHalfmonth.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
      this.txtNextIndexHalfmonth.Location = new Point(525, 378);
      this.txtNextIndexHalfmonth.Name = "txtNextIndexHalfmonth";
      this.txtNextIndexHalfmonth.ReadOnly = true;
      this.txtNextIndexHalfmonth.Size = new Size(39, 20);
      this.txtNextIndexHalfmonth.TabIndex = 39;
      ...
      this.tableFlashDataLogger.AlternatingRowsDefaultCellStyle = gridViewCellStyle4;
      ...
      this.tableFlashDataLogger.DefaultCellStyle = gridViewCellStyle5;
      ...
      this.tableFlashDataLogger.RowsDefaultCellStyle = gridViewCellStyle6;
      ...
      this.tableRamDataLoggerValues.AlternatingRowsDefaultCellStyle = gridViewCellStyle7;
      this.tableRamDataLoggerValues.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left;
      ...
      this.tableRamDataLoggerValues.DefaultCellStyle = gridViewCellStyle8;
      ...
      this.tableRamDataLoggerValues.RowsDefaultCellStyle = gridViewCellStyle9;
      ...
      this.tabValues.Controls.Add((Control) this.tableValues);
      ...
      this.tableValues.AllowUserToAddRows = false;
      this.tableValues.AllowUserToDeleteRows = false;
      this.tableValues.AllowUserToResizeRows = false;
      gridViewCellStyle10.BackColor = Color.FromArgb(228, 241, 244);
      this.tableValues.AlternatingRowsDefaultCellStyle = gridViewCellStyle10;
      this.tableValues.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
      this.tableValues.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;
      this.tableValues.BackgroundColor = Color.White;
      this.tableValues.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
      ...
      this.tableValues.DefaultCellStyle = gridViewCellStyle11;
      this.tableValues.Location = new Point(3, 3);
      this.tableValues.Name = "tableValues";
      this.tableValues.RowHeadersVisible = false;
      this.tableValues.RowHeadersWidthSizeMode = DataGridViewRowHeadersWidthSizeMode.AutoSizeToAllHeaders;
      gridViewCellStyle12.WrapMode = DataGridViewTriState.True;
      this.tableValues.RowsDefaultCellStyle = gridViewCellStyle12;
      this.tableValues.RowTemplate.Resizable = DataGridViewTriState.True;
      this.tableValues.Size = new Size(768, 445);
      this.tableValues.TabIndex = 25;
      ...
      ((ISupportInitialize) this.tableValues).EndInit();
