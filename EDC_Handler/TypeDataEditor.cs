...
// Type: EDC_Handler.TypeDataEditor
...
namespace EDC_Handler
{
  public class TypeDataEditor : Form
  {
    ...
    private EDC_Meter editMeter;
    private EDC_Hardware hardware;
    ...
    internal static void ShowDialog(
      ...
      EDC_HandlerFunctions MyFunctions)
    {
      TypeDataEditor.ShowDialog(owner, hardware, MyFunctions, (EDC_Meter) null, (MeterInfo) null);
    }
    ...
    private void TypeDataEditor_Load(object sender, EventArgs e)
    {
      ...
      this.cboxBaseType.DataSource = (object) EDC_Database.LoadMeterInfo("EDC_BASETYPE", this.hardware);
      ...
      {
        this.txtSapNumber.Text = "EDC_BASETYPE";
    ...
    {
      bool flag = this.txtSapNumber.Text == "EDC_BASETYPE";
    ...
    private void btnSave_Click(object sender, EventArgs e)
    {
      this.error.Clear();
      bool flag = true;
      EDC_Meter selectedHandlerMeter = this.GetSelectedHandlerMeter();
      ...
      if (this.txtSapNumber.Text == "EDC_BASETYPE" && MeterDatabase.GetDatabaseLocationName() != "ZENNER Development")
      {
      ...
      if (this.editMeterInfo == null)
      {
        if (EDC_Database.CreateType(this.txtSapNumber.Text.Trim(), selectedHardwareType.HardwareTypeID, this.txtDescription.Text.Trim(), selectedHandlerMeter))
          this.Close();
        else
      ...
      else
      {
        ...
        if (EDC_Database.UpdateType(this.editMeterInfo, selectedHandlerMeter))
          this.Close();
        else
          ZR_ClassLibMessages.ShowAndClearErrors();
      }
    ...
    private EDC_Meter GetSelectedHandlerMeter()
    {
      ...
      switch ((HandlerMeterType) Enum.Parse(typeof (HandlerMeterType), this.cboxHandlerObject.SelectedItem.ToString()))
      {
        case HandlerMeterType.WorkMeter:
          return this.MyFunctions.WorkMeter != null ? this.MyFunctions.WorkMeter.DeepCopy() : (EDC_Meter) null;
        case HandlerMeterType.TypeMeter:
          return this.MyFunctions.TypeMeter != null ? this.MyFunctions.TypeMeter.DeepCopy() : (EDC_Meter) null;
        case HandlerMeterType.BackupMeter:
          return this.MyFunctions.BackupMeter != null ? this.MyFunctions.BackupMeter.DeepCopy() : (EDC_Meter) null;
        case HandlerMeterType.ConnectedMeter:
          return this.MyFunctions.ConnectedMeter != null ? this.MyFunctions.ConnectedMeter.DeepCopy() : (EDC_Meter) null;
        default:
    ...
    private void RefreshHardwareTypes()
    {
      EDC_Meter selectedHandlerMeter = this.GetSelectedHandlerMeter();
      if (selectedHandlerMeter != null)
        this.cboxHardwareType.DataSource = (object) EDC_Database.LoadHardwareType(selectedHandlerMeter.Version);
      else
        this.cboxHardwareType.DataSource = (object) EDC_Database.LoadHardwareType(this.hardware.ToString());
    }
