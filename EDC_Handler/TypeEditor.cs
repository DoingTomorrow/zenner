...
namespace EDC_Handler
{
  public class TypeEditor : Form
  {
    ...
    private EDC_Meter selectedMeter;
    ...
    {
      if (this.MyFunctions.ConnectedMeter != null)
      {
        this.cboxHardwareType.DataSource = (object) new List<string>()
        {
          this.MyFunctions.ConnectedMeter.Version.Type.ToString()
        };
      }
      else
      {
        List<string> stringList = new List<string>((IEnumerable<string>) Util.GetNamesOfEnum(typeof (EDC_Hardware)));
        stringList.Remove(EDC_Hardware.Unknown.ToString());
        this.cboxHardwareType.DataSource = (object) stringList;
      }
    }
    ...
    private void tableTypes_SelectionChanged(object sender, EventArgs e)
    {
      ...
      try
      {
        this.selectedMeter = this.GetMeterObject(dataBoundItem.MeterInfoID);
      ...
      if (dataBoundItem.PPSArtikelNr == "EDC_BASETYPE")
    ...
    {
      TypeDataEditor.ShowDialog((Form) this, (EDC_Hardware) Enum.Parse(typeof (EDC_Hardware), this.cboxHardwareType.SelectedValue.ToString(), true), this.MyFunctions);
    ...
    private void btnEdit_Click(object sender, EventArgs e)
    {
      ...
      if (selectedType == null)
        return;
      TypeDataEditor.ShowDialog((Form) this, (EDC_Hardware) Enum.Parse(typeof (EDC_Hardware), this.cboxHardwareType.SelectedValue.ToString(), true), this.MyFunctions, this.selectedMeter, selectedType);
      this.InitializeControls();
    }
    ...
    private void btnDelete_Click(object sender, EventArgs e)
    {
      ...
      if (selectedType == null || MessageBox.Show("Are you sure to delete the type?", "Delete?", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) != DialogResult.OK)
        return;
      EDC_Database.DeleteType(selectedType.MeterInfoID);
      this.InitializeControls();
    }
    ...
    private void InitializeControls()
    {
      ...
      this.tableTypes.DataSource = (object) MeterDatabase.LoadMeterInfoByHardwareName(((EDC_Hardware) Enum.Parse(typeof (EDC_Hardware), this.cboxHardwareType.SelectedValue.ToString(), true)).ToString());
    ...
    private EDC_Meter GetMeterObject(int meterInfoID)
    {
      MeterTypeData meterTypeData = EDC_Database.LoadType(meterInfoID);
      return meterTypeData == null ? (EDC_Meter) null : EDC_Meter.Unzip(meterTypeData.EEPdata);
    }

    private void cboxHardwareType_SelectedIndexChanged(object sender, EventArgs e)
    {
      this.InitializeControls();
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.btnNew.Location = new Point(683, 46);
      ...
      this.btnDelete.Location = new Point(683, 116);
      ...
      this.btnEdit.Location = new Point(683, 81);
      ...
      this.label36.Location = new Point(199, 8);
      ...
      this.cboxHardwareType.Location = new Point(291, 6);
      this.cboxHardwareType.Name = "cboxHardwareType";
      this.cboxHardwareType.Size = new Size(132, 21);
      this.cboxHardwareType.TabIndex = 69;
      this.cboxHardwareType.SelectedIndexChanged += new System.EventHandler(this.cboxHardwareType_SelectedIndexChanged);
