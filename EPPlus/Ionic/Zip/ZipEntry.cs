...
namespace Ionic.Zip
{
  ...
  internal class ZipEntry
  {
    ...
    {
      get => this._InternalFileAttrs == (short) 0 && (this._ExternalFileAttrs & 16) == 16;
    }
    ...
    internal void Extract() => this.InternalExtract(".", (Stream) null, (string) null);
    ...
    internal void ExtractWithPassword(
...
label_8:
    ...
    {
      return this._UncompressedSize >= 16L && this._CompressionMethod != (short) 0 && this.CompressionLevel != CompressionLevel.None && this._CompressedSize >= this._UncompressedSize && (this._Source != ZipEntrySource.Stream || this._sourceStream.CanSeek) && (this._zipCrypto_forWrite == null || this.CompressedSize - 12L > this.UncompressedSize);
    }
    ...
    {
      return this.Encryption == EncryptionAlgorithm.PkzipWeak ? (Stream) new ZipCipherStream(s, this._zipCrypto_forWrite, CryptoMode.Encrypt) : s;
    }
