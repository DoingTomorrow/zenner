...
namespace Ionic.Zip
{
  ...
  internal class ZipFile : IEnumerable<ZipEntry>, IEnumerable, IDisposable
  {
    ...
    public int MaxOutputSegmentSize
    {
      ...
      set
      {
        this._maxOutputSegmentSize = value >= 65536 || value == 0 ? value : throw new ZipException("The minimum acceptable segment size is 65536.");
      }
    }

    public int NumberOfSegmentsForMostRecentSave
    {
      get => (int) this._numberOfSegmentsForMostRecentSave + 1;
    }
    ...
    public long ParallelDeflateThreshold
    {
      set
      {
        this._ParallelDeflateThreshold = value == 0L || value == -1L || value >= 65536L ? value : throw new ArgumentOutOfRangeException("ParallelDeflateThreshold should be -1, 0, or > 65536");
      }
    ...
    internal void ExtractSelectedEntries(
      string selectionCriteria,
