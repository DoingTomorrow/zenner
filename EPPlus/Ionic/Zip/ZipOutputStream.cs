...
namespace Ionic.Zip
{
  internal class ZipOutputStream : Stream
  {
    ...
    {
      return string.Format("ZipOutputStream::{0}(leaveOpen({1})))", (object) this._name, (object) this._leaveUnderlyingStreamOpen);
    }
    ...
    public long ParallelDeflateThreshold
    {
      set
      {
        this._ParallelDeflateThreshold = value == 0L || value == -1L || value >= 65536L ? value : throw new ArgumentOutOfRangeException("value must be greater than 64k, or 0, or -1");
      }
