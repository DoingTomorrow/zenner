...
// Type: OfficeOpenXml.ConditionalFormatting.ExcelConditionalFormattingBeginsWith
    ...
    IExcelConditionalFormattingWithText
  {
    ...
    public string Text
    {
      ...
      set
      {
        ...
        this.Formula = string.Format("LEFT({0},LEN(\"{1}\"))=\"{1}\"", (object) this.Address.Start.Address, (object) value.Replace("\"", "\"\""));
      }
    }
  }
}
