...
// Type: OfficeOpenXml.DataValidation.ExcelDataValidationList
...
namespace OfficeOpenXml.DataValidation
{
    ...
    IExcelDataValidation
  {
    ...
    {
      this.Formula = (IExcelDataValidationFormulaList) new ExcelDataValidationFormulaList(this.NameSpaceManager, this.TopNode, this._formula1Path);
    }
