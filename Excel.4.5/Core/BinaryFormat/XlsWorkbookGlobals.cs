...
namespace Excel.Core.BinaryFormat
{
  internal class XlsWorkbookGlobals
  {
    ...
    {
      get => this.m_InterfaceHdr;
      set => this.m_InterfaceHdr = value;
    }

    public XlsBiffRecord MMS
    {
      get => this.m_MMS;
      set => this.m_MMS = value;
    }

    public XlsBiffRecord WriteAccess
    {
      get => this.m_WriteAccess;
      set => this.m_WriteAccess = value;
    }
    ...
    {
      get => this.m_Backup;
      set => this.m_Backup = value;
    }

    public List<XlsBiffRecord> Fonts => this.m_Fonts;

    public Dictionary<ushort, XlsBiffFormatString> Formats => this.m_Formats;

    public List<XlsBiffRecord> ExtendedFormats => this.m_ExtendedFormats;

    public List<XlsBiffRecord> Styles => this.m_Styles;

    public List<XlsBiffBoundSheet> Sheets => this.m_Sheets;
