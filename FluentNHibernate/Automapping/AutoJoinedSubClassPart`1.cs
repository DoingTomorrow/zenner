...
// Type: FluentNHibernate.Automapping.AutoJoinedSubClassPart`1
...
{
  public class AutoJoinedSubClassPart<T> : JoinedSubClassPart<T>, IAutoClasslike, IMappingProvider
  {
    ...
    private AutoJoinedSubClassPart(string keyColumn, MappingProviderStore providers)
