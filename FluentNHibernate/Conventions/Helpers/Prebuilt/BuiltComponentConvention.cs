...
// Type: FluentNHibernate.Conventions.Helpers.Prebuilt.BuiltComponentConvention
...
namespace FluentNHibernate.Conventions.Helpers.Prebuilt
{
  public class BuiltComponentConvention(
    ...
    BuiltConventionBase<IComponentInspector, IComponentInstance>(accept, convention),
    IComponentConvention,
    IConvention<IComponentInspector, IComponentInstance>,
    IConvention,
    IComponentConventionAcceptance,
    IConventionAcceptance<IComponentInspector>
  {
  }
}
