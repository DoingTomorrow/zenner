...
// Type: FluentNHibernate.Conventions.Helpers.Prebuilt.BuiltKeyPropertyConvention
...
namespace FluentNHibernate.Conventions.Helpers.Prebuilt
{
  internal class BuiltKeyPropertyConvention(
    ...
    BuiltConventionBase<IKeyPropertyInspector, IKeyPropertyInstance>(accept, convention),
    IKeyPropertyConvention,
    IConvention<IKeyPropertyInspector, IKeyPropertyInstance>,
    IConvention,
    IKeyPropertyConventionAcceptance,
    IConventionAcceptance<IKeyPropertyInspector>
  {
  }
}
