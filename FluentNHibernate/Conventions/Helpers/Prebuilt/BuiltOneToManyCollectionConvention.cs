...
// Type: FluentNHibernate.Conventions.Helpers.Prebuilt.BuiltOneToManyCollectionConvention
...
namespace FluentNHibernate.Conventions.Helpers.Prebuilt
{
  public class BuiltOneToManyCollectionConvention(
    ...
    IHasManyConvention,
    IConvention<IOneToManyCollectionInspector, IOneToManyCollectionInstance>,
    IConvention,
    IHasManyConventionAcceptance,
    IConventionAcceptance<IOneToManyCollectionInspector>
  {
  }
}
