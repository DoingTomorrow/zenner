...
// Type: FluentNHibernate.Conventions.Helpers.Prebuilt.BuiltReferenceConvention
...
namespace FluentNHibernate.Conventions.Helpers.Prebuilt
{
  internal class BuiltReferenceConvention(
    ...
    BuiltConventionBase<IManyToOneInspector, IManyToOneInstance>(accept, convention),
    IReferenceConvention,
    IConvention<IManyToOneInspector, IManyToOneInstance>,
    IConvention,
    IReferenceConventionAcceptance,
    IConventionAcceptance<IManyToOneInspector>
  {
  }
}
