...
// Type: FluentNHibernate.Conventions.Helpers.Prebuilt.BuiltSubclassConvention
...
namespace FluentNHibernate.Conventions.Helpers.Prebuilt
{
  internal class BuiltSubclassConvention(
    ...
    BuiltConventionBase<ISubclassInspector, ISubclassInstance>(accept, convention),
    ISubclassConvention,
    IConvention<ISubclassInspector, ISubclassInstance>,
    IConvention,
    ISubclassConventionAcceptance,
    IConventionAcceptance<ISubclassInspector>
  {
  }
}
