...
// Type: FluentNHibernate.Conventions.Instances.ComponentInstance
    ...
    IInspector
  {
    ...
    public IComponentInstance Not
    {
      get
      {
        ...
        return (IComponentInstance) this;
      }
    }

    public void LazyLoad()
    {
      this.mapping.Set<bool>((Expression<Func<ComponentMapping, bool>>) (x => x.Lazy), 1, (this.nextBool ? 1 : 0) != 0);
      this.nextBool = true;
    }
