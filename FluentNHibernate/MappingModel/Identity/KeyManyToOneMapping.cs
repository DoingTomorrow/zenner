...
// Type: FluentNHibernate.MappingModel.Identity.KeyManyToOneMapping
  ...
  public class KeyManyToOneMapping : MappingBase, ICompositeIdKeyMapping
  {
    ...
    public override bool Equals(object obj)
    {
      ...
      if (object.ReferenceEquals((object) this, obj))
        return true;
      return obj.GetType() == typeof (KeyManyToOneMapping) && this.Equals((KeyManyToOneMapping) obj);
    }
    ...
    public void Set<T>(
      Expression<Func<KeyManyToOneMapping, T>> expression,
      int layer,
      T value)
    {
      this.Set(expression.ToMember<KeyManyToOneMapping, T>().Name, layer, (object) value);
    }
