...
namespace ICSharpCode.SharpZipLib.Tar
{
  public class TarArchive : IDisposable
  {
    ...
    public static TarArchive CreateInputTarArchive(Stream inputStream)
    {
      ...
      return inputStream is TarInputStream stream ? new TarArchive(stream) : TarArchive.CreateInputTarArchive(inputStream, 20);
    }
    ...
    public static TarArchive CreateOutputTarArchive(Stream outputStream)
    {
      ...
      return outputStream is TarOutputStream stream ? new TarArchive(stream) : TarArchive.CreateOutputTarArchive(outputStream, 20);
    }
