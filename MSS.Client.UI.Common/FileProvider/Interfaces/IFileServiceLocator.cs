...
// Type: MSS.Client.UI.Common.FileProvider.Interfaces.IFileServiceLocator
...
{
  public interface IFileServiceLocator
  {
    IFileProvider GetProvider(Func<string, bool> condition);
  }
}
