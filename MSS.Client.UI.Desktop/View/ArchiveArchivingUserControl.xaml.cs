...
// Type: MSS.Client.UI.Desktop.View.Archive.ArchivingUserControl
...
namespace MSS.Client.UI.Desktop.View.Archive
{
  public partial class ArchivingUserControl : UserControl, IComponentConnector
  {
    ...
    internal TextBlock ArchiveNameTitle;
    ...
    internal Button CreateArchiveJob;
    internal Button EditArchiveJob;
    internal Button DeleteArchiveJob;
    internal Button RunArchiveJob;
    internal RadGridView ArchiveJobsGridView;
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Desktop;component/view/archive/archivingusercontrol.xaml", UriKind.Relative));
    }
    ...
    void IComponentConnector.Connect(int connectionId, object target)
    {
      switch (connectionId)
      {
        ...
        case 4:
          ...
          break;
        case 5:
          this.ArchiveNameTitle = (TextBlock) target;
          break;
        case 6:
        ...
        case 13:
          ...
          break;
        case 14:
          this.CreateArchiveJob = (Button) target;
          break;
        case 15:
          this.EditArchiveJob = (Button) target;
          break;
        case 16:
          this.DeleteArchiveJob = (Button) target;
          break;
        case 17:
          this.RunArchiveJob = (Button) target;
          break;
        case 18:
          this.ArchiveJobsGridView = (RadGridView) target;
          break;
        default:
          this._contentLoaded = true;
          break;
