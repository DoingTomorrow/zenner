...
// Type: MSS.Client.UI.Desktop.View.Archive.ViewArchiveMinomatDialog
...
{
  public partial class ViewArchiveMinomatDialog : ResizableMetroWindow, IComponentConnector
  {
    internal CheckBox isMaster;
    internal Button CancelButton1;
    private bool _contentLoaded;

    public ViewArchiveMinomatDialog()
    {
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Desktop;component/view/archive/viewarchiveminomatdialog.xaml", UriKind.Relative));
    }
