...
// Type: MSS.Client.UI.Desktop.View.Archive.ViewArchiveTenantDialog
...
{
  public partial class ViewArchiveTenantDialog : ResizableMetroWindow, IComponentConnector
  {
    internal CheckBox GroupCheckBox;
    internal Button CancelButton;
    private bool _contentLoaded;

    public ViewArchiveTenantDialog()
    {
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Desktop;component/view/archive/viewarchivetenantdialog.xaml", UriKind.Relative));
    }
    ...
    void IComponentConnector.Connect(int connectionId, object target)
    {
      ...
      {
        case 1:
          this.GroupCheckBox = (CheckBox) target;
          break;
        case 2:
