...
// Type: MSS.Client.UI.Desktop.View.DataCollectors.DeleteDataCollectorDialog
...
{
  public partial class DeleteDataCollectorDialog : ResizableMetroWindow, IComponentConnector
  {
    internal Button OkButton;
    internal Button CancelButton;
    private bool _contentLoaded;

    public DeleteDataCollectorDialog()
    {
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Desktop;component/view/datacollectors/deletedatacollectordialog.xaml", UriKind.Relative));
    }
