...
// Type: MSS.Client.UI.Desktop.View.DataFilters.UpdateFilterDialog
...
{
  public partial class UpdateFilterDialog : ResizableMetroWindow, IComponentConnector
  {
    internal Button OkButton;
    internal Button CancelButton;
    private bool _contentLoaded;

    public UpdateFilterDialog()
    {
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Desktop;component/view/datafilters/updatefilterdialog.xaml", UriKind.Relative));
    }
