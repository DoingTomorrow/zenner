...
// Type: MSS.Client.UI.Desktop.View.Jobs.DeleteJobDefinitionDialog
...
{
  public partial class DeleteJobDefinitionDialog : ResizableMetroWindow, IComponentConnector
  {
    internal Button OkButton;
    internal Button CanceButton;
    private bool _contentLoaded;

    public DeleteJobDefinitionDialog()
    {
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Desktop;component/view/jobs/deletejobdefinitiondialog.xaml", UriKind.Relative));
    }
