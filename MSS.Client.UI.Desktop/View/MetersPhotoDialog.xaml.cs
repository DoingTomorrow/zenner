...
// Type: MSS.Client.UI.Desktop.View.Meters.PhotoDialog
...
{
  public partial class PhotoDialog : ResizableMetroWindow, IComponentConnector
  {
    internal Image ViewedPhoto;
    ...
    {
      this.ViewedPhoto.Source = this.SelectedPhoto;
    }
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Desktop;component/view/meters/photodialog.xaml", UriKind.Relative));
    }
    ...
    void IComponentConnector.Connect(int connectionId, object target)
    {
      ...
      {
        case 1:
          ((FrameworkElement) target).Loaded += new RoutedEventHandler(this.PhotoViewWindowLoaded);
          break;
        case 2:
          this.ViewedPhoto = (Image) target;
          break;
        default:
          this._contentLoaded = true;
          break;
