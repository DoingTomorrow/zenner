...
// Type: MSS.Client.UI.Desktop.View.Orders.DeleteReadingOrder
...
{
  public class DeleteReadingOrder : ResizableMetroWindow, IComponentConnector
  {
    internal Button OkButton;
    internal Button CancelButton;
    private bool _contentLoaded;

    public DeleteReadingOrder()
    {
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Desktop;component/view/orders/deleteorder.xaml", UriKind.Relative));
    }
