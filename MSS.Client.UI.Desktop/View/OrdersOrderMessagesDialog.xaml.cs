...
// Type: MSS.Client.UI.Desktop.View.Orders.OrderMessagesDialog
...
namespace MSS.Client.UI.Desktop.View.Orders
{
  public partial class OrderMessagesDialog : ResizableMetroWindow, IComponentConnector
  {
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Desktop;component/view/orders/ordermessagesdialog.xaml", UriKind.Relative));
    }
    ...
    void IComponentConnector.Connect(int connectionId, object target)
    {
      ...
      {
        case 1:
          ((UIElement) target).MouseDown += new MouseButtonEventHandler(((ResizableMetroWindow) this).Drag_Window);
          break;
        case 2:
