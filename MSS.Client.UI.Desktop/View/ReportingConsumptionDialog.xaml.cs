...
// Type: MSS.Client.UI.Desktop.View.Reporting.ConsumptionDialog
...
{
  public partial class ConsumptionDialog : ResizableMetroWindow, IComponentConnector
  {
    internal RadCartesianChart barSeries;
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Desktop;component/view/reporting/consumptiondialog.xaml", UriKind.Relative));
    }
    ...
    {
      if (connectionId == 1)
        this.barSeries = (RadCartesianChart) target;
      else
        this._contentLoaded = true;
    }
  }
