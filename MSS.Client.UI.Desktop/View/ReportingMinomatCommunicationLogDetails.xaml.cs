...
// Type: MSS.Client.UI.Desktop.View.Reporting.MinomatCommunicationLogDetails
...
{
  public partial class MinomatCommunicationLogDetails : ResizableMetroWindow, IComponentConnector
  {
    internal Button CancelButton;
    private bool _contentLoaded;

    public MinomatCommunicationLogDetails()
    {
    ...
    ~MinomatCommunicationLogDetails()
    {
      this.MouseLeftButtonUp -= new MouseButtonEventHandler(((ResizableMetroWindow) this).OnMouseLeftButtonUp);
      this.StateChanged -= new EventHandler(((ResizableMetroWindow) this).OnStateChanged);
      this.Deactivated -= new EventHandler(((ResizableMetroWindow) this).Window_Deactivated);
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Desktop;component/view/reporting/minomatcommunicationlogdetails.xaml", UriKind.Relative));
    }
