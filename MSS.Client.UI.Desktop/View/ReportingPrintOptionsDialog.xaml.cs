...
// Type: MSS.Client.UI.Desktop.View.Reporting.PrintOptionsDialog
...
{
  public partial class PrintOptionsDialog : ResizableMetroWindow, IComponentConnector
  {
    internal ListBox ColumnsListBox;
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Desktop;component/view/reporting/printoptionsdialog.xaml", UriKind.Relative));
    }
    ...
    {
      if (connectionId == 1)
        this.ColumnsListBox = (ListBox) target;
      else
        this._contentLoaded = true;
    }
  }
