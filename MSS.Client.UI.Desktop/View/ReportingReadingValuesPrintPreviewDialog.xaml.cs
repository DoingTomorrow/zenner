...
// Type: MSS.Client.UI.Desktop.View.Reporting.ReadingValuesPrintPreviewDialog
...
{
  public partial class ReadingValuesPrintPreviewDialog : ResizableMetroWindow, IComponentConnector
  {
    private int _currentPagingNumber = 0;
    internal RadButton Print;
    internal Grid MeterReadingValuesGrid;
    internal RadGridView MeterReadingValuesGridView;
    private bool _contentLoaded;

    public ReadingValuesPrintPreviewDialog()
    {
    ...
    ~ReadingValuesPrintPreviewDialog()
    {
      this.MouseLeftButtonUp -= new MouseButtonEventHandler(((ResizableMetroWindow) this).OnMouseLeftButtonUp);
      this.StateChanged -= new EventHandler(((ResizableMetroWindow) this).OnStateChanged);
      this.Deactivated -= new EventHandler(((ResizableMetroWindow) this).Window_Deactivated);
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Desktop;component/view/reporting/readingvaluesprintpreviewdialog.xaml", UriKind.Relative));
    }
    ...
    void IComponentConnector.Connect(int connectionId, object target)
    {
      ...
      {
        case 1:
          this.Print = (RadButton) target;
          break;
        case 2:
          this.MeterReadingValuesGrid = (Grid) target;
          break;
        case 3:
