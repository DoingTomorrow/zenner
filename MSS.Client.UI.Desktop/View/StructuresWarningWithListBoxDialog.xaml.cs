...
// Type: MSS.Client.UI.Desktop.View.Structures.WarningWithListBoxDialog
...
{
  public partial class WarningWithListBoxDialog : ResizableMetroWindow, IComponentConnector
  {
    internal Button OkButton;
    internal Button CancelButton;
    private bool _contentLoaded;

    public WarningWithListBoxDialog()
    {
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Desktop;component/view/structures/warningwithlistboxdialog.xaml", UriKind.Relative));
    }
