...
// Type: MSS.Client.UI.Desktop.View.GenericMessageConfirmationDialog
...
{
  public partial class GenericMessageConfirmationDialog : ResizableMetroWindow, IComponentConnector
  {
    internal Button OkButton;
    internal Button CancelButton;
    private bool _contentLoaded;

    public GenericMessageConfirmationDialog()
    {
    ...
    ~GenericMessageConfirmationDialog()
    {
      this.MouseLeftButtonUp -= new MouseButtonEventHandler(((ResizableMetroWindow) this).OnMouseLeftButtonUp);
      this.StateChanged -= new EventHandler(((ResizableMetroWindow) this).OnStateChanged);
      this.Deactivated -= new EventHandler(((ResizableMetroWindow) this).Window_Deactivated);
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Desktop;component/view/genericmessageconfirmationdialog.xaml", UriKind.Relative));
    }
