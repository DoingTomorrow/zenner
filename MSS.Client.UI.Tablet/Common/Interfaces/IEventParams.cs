...
// Type: MSS.Client.UI.Tablet.Common.Interfaces.IEventParams
...
#nullable disable
namespace MSS.Client.UI.Tablet.Common.Interfaces
{
  public interface IEventParams
  {
    FrameworkElement FrameworkElement { get; set; }

    RoutedEventArgs RoutedEventArgs { get; set; }

    object UserControlElement { get; set; }
  }
}
