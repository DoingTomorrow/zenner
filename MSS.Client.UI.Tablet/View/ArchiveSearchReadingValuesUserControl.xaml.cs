...
// Type: MSS.Client.UI.Tablet.View.Archive.SearchReadingValuesUserControl
...
namespace MSS.Client.UI.Tablet.View.Archive
{
  public partial class SearchReadingValuesUserControl : UserControl, IComponentConnector
  {
    ...
    public SearchReadingValuesUserControl() => this.InitializeComponent();
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Tablet;component/view/archive/searchreadingvaluesusercontrol.xaml", UriKind.Relative));
    }
