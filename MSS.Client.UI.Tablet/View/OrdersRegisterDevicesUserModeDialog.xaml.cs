...
// Type: MSS.Client.UI.Tablet.View.Orders.RegisterDevicesUserModeDialog
...
{
  public partial class RegisterDevicesUserModeDialog : ResizableMetroWindow, IComponentConnector
  {
    internal RadBusyIndicator BusyIndicator;
    private bool _contentLoaded;

    public RegisterDevicesUserModeDialog()
    {
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Tablet;component/view/orders/registerdevicesusermodedialog.xaml", UriKind.Relative));
    }
