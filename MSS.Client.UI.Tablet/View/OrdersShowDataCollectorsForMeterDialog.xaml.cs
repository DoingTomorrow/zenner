...
// Type: MSS.Client.UI.Tablet.View.Orders.ShowDataCollectorsForMeterDialog
...
{
  public partial class ShowDataCollectorsForMeterDialog : ResizableMetroWindow, IComponentConnector
  {
    internal RadGridView RadGridView;
    private bool _contentLoaded;

    public ShowDataCollectorsForMeterDialog()
    {
    ...
    ~ShowDataCollectorsForMeterDialog()
    {
      this.SourceInitialized -= new EventHandler(((ResizableMetroWindow) this).win_SourceInitialized);
      this.MouseLeftButtonUp -= new MouseButtonEventHandler(((ResizableMetroWindow) this).OnMouseLeftButtonUp);
    }
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Tablet;component/view/orders/showdatacollectorsformeterdialog.xaml", UriKind.Relative));
    }
