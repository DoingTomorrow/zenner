...
// Type: MSS.Client.UI.Tablet.View.Orders.ShowRoutingTableDialog
...
{
  public partial class ShowRoutingTableDialog : ResizableMetroWindow, IComponentConnector
  {
    internal DataGrid DataGrid;
    internal RadTreeListView RadTreeListView;
    private bool _contentLoaded;

    public ShowRoutingTableDialog()
    {
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Tablet;component/view/orders/showroutingtabledialog.xaml", UriKind.Relative));
    }
    ...
    void IComponentConnector.Connect(int connectionId, object target)
    {
      switch (connectionId)
      {
        case 1:
          ...
          break;
        case 2:
          this.RadTreeListView = (RadTreeListView) target;
          break;
        default:
          this._contentLoaded = true;
          break;
