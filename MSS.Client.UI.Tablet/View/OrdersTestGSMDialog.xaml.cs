...
// Type: MSS.Client.UI.Tablet.View.Orders.TestGSMDialog
...
{
  public partial class TestGSMDialog : ResizableMetroWindow, IComponentConnector
  {
    internal RadBusyIndicator BusyIndicator;
    internal Button StartGsmTestButton;
    private bool _contentLoaded;

    public TestGSMDialog()
    {
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Tablet;component/view/orders/testgsmdialog.xaml", UriKind.Relative));
    }
    ...
    void IComponentConnector.Connect(int connectionId, object target)
    {
      switch (connectionId)
      {
        case 1:
          ...
          break;
        case 2:
          this.StartGsmTestButton = (Button) target;
          break;
        default:
          this._contentLoaded = true;
          break;
