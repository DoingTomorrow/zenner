...
// Type: MSS.Client.UI.Tablet.View.Settings.ProfileTypeDialog
...
namespace MSS.Client.UI.Tablet.View.Settings
{
  public partial class ProfileTypeDialog : ResizableMetroWindow, IComponentConnector
  {
    ...
    public void BuildGrid(List<Config> profileTypeConfigParams)
    {
      ...
      int dynamicGrid2 = (int) DynamicGridControl.CreateDynamicGrid((IList<Config>) profileTypeConfigParams, out dynamicGrid1, gridWidth: 850.0, firstColumnPercentage: 40.0, isTabletMode: new bool?(true));
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Tablet;component/view/settings/profiletypedialog.xaml", UriKind.Relative));
    }
