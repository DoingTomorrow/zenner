...
// Type: MSS.Client.UI.Tablet.View.Structures.CreatePhysicalStructureDialog
...
namespace MSS.Client.UI.Tablet.View.Structures
{
  public partial class CreatePhysicalStructureDialog : ResizableMetroWindow, IComponentConnector
  {
    ...
    internal TextBlock txtBlockPhotos;
    ...
    public void InitializeComponent()
    {
      ...
      System.Windows.Application.LoadComponent((object) this, new Uri("/MSS.Client.UI.Tablet;component/view/structures/createphysicalstructuredialog.xaml", UriKind.Relative));
    }
    ...
    void IComponentConnector.Connect(int connectionId, object target)
    {
      switch (connectionId)
      {
        ...
        case 8:
          ...
          break;
        case 9:
          this.txtBlockPhotos = (TextBlock) target;
          break;
        case 10:
