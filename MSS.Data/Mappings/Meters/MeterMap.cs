...
// Type: MSS.Data.Mappings.Meters.MeterMap
...
namespace MSS.Data.Mappings.Meters
{
  public sealed class MeterMap : ClassMap<Meter>
  {
    ...
    {
      this.Table("t_Meter");
      this.Id((Expression<Func<Meter, object>>) (n => (object) n.Id)).GeneratedBy.GuidComb();
      ...
      this.Map((Expression<Func<Meter, object>>) (t => (object) t.LastMDMExportOn));
