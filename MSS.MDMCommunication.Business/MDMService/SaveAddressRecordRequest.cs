...
// Type: MSS.MDMCommunication.Business.MDMService.SaveAddressRecordRequest
...
namespace MSS.MDMCommunication.Business.MDMService
{
  ...
  [MessageContract(WrapperName = "SaveAddressRecord", WrapperNamespace = "http://tempuri.org/", IsWrapped = true)]
  public class SaveAddressRecordRequest
  {
    ...
    public SaveAddressRecordRequest()
    {
    }
