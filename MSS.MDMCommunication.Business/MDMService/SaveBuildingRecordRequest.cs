...
// Type: MSS.MDMCommunication.Business.MDMService.SaveBuildingRecordRequest
...
namespace MSS.MDMCommunication.Business.MDMService
{
  ...
  [MessageContract(WrapperName = "SaveBuildingRecord", WrapperNamespace = "http://tempuri.org/", IsWrapped = true)]
  public class SaveBuildingRecordRequest
  {
    ...
    public SaveBuildingRecordRequest()
    {
    }
