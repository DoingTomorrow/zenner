...
// Type: MSS.MDMCommunication.Business.MDMService.SaveDCUConnectionRecordRequest
...
namespace MSS.MDMCommunication.Business.MDMService
{
  ...
  [MessageContract(WrapperName = "SaveDCUConnectionRecord", WrapperNamespace = "http://tempuri.org/", IsWrapped = true)]
  public class SaveDCUConnectionRecordRequest
  {
    ...
    public SaveDCUConnectionRecordRequest()
    {
    }
