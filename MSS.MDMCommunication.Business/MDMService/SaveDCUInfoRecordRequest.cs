...
// Type: MSS.MDMCommunication.Business.MDMService.SaveDCUInfoRecordRequest
...
namespace MSS.MDMCommunication.Business.MDMService
{
  ...
  [MessageContract(WrapperName = "SaveDCUInfoRecord", WrapperNamespace = "http://tempuri.org/", IsWrapped = true)]
  public class SaveDCUInfoRecordRequest
  {
    ...
    public SaveDCUInfoRecordRequest()
    {
    }
