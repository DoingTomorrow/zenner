...
// Type: MSS.MDMCommunication.Business.MDMService.SaveDeviceInfoRecordRequest
...
namespace MSS.MDMCommunication.Business.MDMService
{
  ...
  [MessageContract(WrapperName = "SaveDeviceInfoRecord", WrapperNamespace = "http://tempuri.org/", IsWrapped = true)]
  public class SaveDeviceInfoRecordRequest
  {
    ...
    public SaveDeviceInfoRecordRequest()
    {
    }
