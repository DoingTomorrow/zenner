...
// Type: MSS.MDMCommunication.Business.MDMService.SavePortfolioRecordRequest
...
namespace MSS.MDMCommunication.Business.MDMService
{
  ...
  [MessageContract(WrapperName = "SavePortfolioRecord", WrapperNamespace = "http://tempuri.org/", IsWrapped = true)]
  public class SavePortfolioRecordRequest
  {
    ...
    public SavePortfolioRecordRequest()
    {
    }
