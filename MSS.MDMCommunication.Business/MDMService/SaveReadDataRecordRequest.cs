...
// Type: MSS.MDMCommunication.Business.MDMService.SaveReadDataRecordRequest
...
namespace MSS.MDMCommunication.Business.MDMService
{
  ...
  [MessageContract(WrapperName = "SaveReadDataRecord", WrapperNamespace = "http://tempuri.org/", IsWrapped = true)]
  public class SaveReadDataRecordRequest
  {
    ...
    public SaveReadDataRecordRequest()
    {
    }
