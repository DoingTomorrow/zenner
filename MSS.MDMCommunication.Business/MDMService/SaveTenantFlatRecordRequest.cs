...
// Type: MSS.MDMCommunication.Business.MDMService.SaveTenantFlatRecordRequest
...
namespace MSS.MDMCommunication.Business.MDMService
{
  ...
  [MessageContract(WrapperName = "SaveTenantFlatRecord", WrapperNamespace = "http://tempuri.org/", IsWrapped = true)]
  public class SaveTenantFlatRecordRequest
  {
    ...
    public SaveTenantFlatRecordRequest()
    {
    }
