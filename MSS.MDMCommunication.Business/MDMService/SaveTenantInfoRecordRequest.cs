...
// Type: MSS.MDMCommunication.Business.MDMService.SaveTenantInfoRecordRequest
...
namespace MSS.MDMCommunication.Business.MDMService
{
  ...
  [MessageContract(WrapperName = "SaveTenantInfoRecord", WrapperNamespace = "http://tempuri.org/", IsWrapped = true)]
  public class SaveTenantInfoRecordRequest
  {
    ...
    public SaveTenantInfoRecordRequest()
    {
    }
