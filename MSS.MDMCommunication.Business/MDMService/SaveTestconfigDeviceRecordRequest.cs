...
// Type: MSS.MDMCommunication.Business.MDMService.SaveTestconfigDeviceRecordRequest
...
namespace MSS.MDMCommunication.Business.MDMService
{
  ...
  [MessageContract(WrapperName = "SaveTestconfigDeviceRecord", WrapperNamespace = "http://tempuri.org/", IsWrapped = true)]
  public class SaveTestconfigDeviceRecordRequest
  {
    ...
    public SaveTestconfigDeviceRecordRequest()
    {
    }
