...
// Type: MSS.MDMCommunication.Business.MDMService.SaveTestconfigRunRecordRequest
...
namespace MSS.MDMCommunication.Business.MDMService
{
  ...
  [MessageContract(WrapperName = "SaveTestconfigRunRecord", WrapperNamespace = "http://tempuri.org/", IsWrapped = true)]
  public class SaveTestconfigRunRecordRequest
  {
    ...
    public SaveTestconfigRunRecordRequest()
    {
    }
