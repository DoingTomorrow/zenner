...
// Type: MVVM.Converters.MandatoryValueLabelConverter
...
namespace MVVM.Converters
{
  ...
  public class MandatoryValueLabelConverter : IValueConverter
  {
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
      return value == null || ((string) value).Length == 0 ? (object) null : (object) ((string) value + " *");
    }
