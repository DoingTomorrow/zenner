...
// Type: MVVM.Converters.NodeToIsMinomatConverter
...
{
  public class NodeToIsMinomatConverter : IValueConverter
  {
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
      return value is StructureNodeDTO && ((StructureNodeDTO) value).NodeType.Name.Contains("Minomat") ? (object) true : (object) false;
    }
