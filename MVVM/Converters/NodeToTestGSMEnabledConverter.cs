...
// Type: MVVM.Converters.NodeToTestGSMEnabledConverter
...
{
  public class NodeToTestGSMEnabledConverter : IValueConverter
  {
    ...
    public object ConvertBack(
      ...
      CultureInfo culture)
    {
      throw new InvalidOperationException("NodeToTestGSMEnabledConverter can only be used OneWay.");
    }
  }
}
