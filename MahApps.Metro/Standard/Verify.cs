...
namespace Standard
{
  internal static class Verify
  {
    ...
    {
      if ((object) obj == null)
        throw new InvalidOperationException(string.Format((IFormatProvider) CultureInfo.InvariantCulture, "The property {0} cannot be null at this time.", new object[1]
        {
          (object) name
        }));
    }
    ...
    {
      if ((object) obj != null)
        throw new InvalidOperationException(string.Format((IFormatProvider) CultureInfo.InvariantCulture, "The property {0} must be null at this time.", new object[1]
        {
          (object) name
        }));
    }
      ...
      string parameterName)
    {
      if (value < lowerBoundInclusive || value >= upperBoundExclusive)
        throw new ArgumentException(string.Format((IFormatProvider) CultureInfo.InvariantCulture, "The integer value must be bounded with [{0}, {1})", new object[2]
        {
    ...
    public static void FileExists(string filePath, string parameterName)
    {
      ...
      if (!File.Exists(filePath))
        throw new ArgumentException(string.Format((IFormatProvider) CultureInfo.InvariantCulture, "No file exists at \"{0}\"", new object[1]
        {
          (object) filePath
        }), parameterName);
    }
      ...
      string parameterName)
    {
      ...
      if (!flag)
        throw new ArgumentException(string.Format((IFormatProvider) CultureInfo.InvariantCulture, "The parameter must implement interface {0}.", new object[1]
        {
          (object) interfaceType.ToString()
        }), parameterName);
    }
  }
}
