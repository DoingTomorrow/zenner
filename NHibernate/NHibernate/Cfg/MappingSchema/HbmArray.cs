...
// Type: NHibernate.Cfg.MappingSchema.HbmArray
...
namespace NHibernate.Cfg.MappingSchema
{
  ...
  [XmlRoot("array", Namespace = "urn:nhibernate-mapping-2.2", IsNullable = false)]
  [DebuggerStepThrough]
  [DesignerCategory("code")]
  [XmlType(AnonymousType = true, Namespace = "urn:nhibernate-mapping-2.2")]
  [Serializable]
  public class HbmArray : 
    AbstractDecoratable,
