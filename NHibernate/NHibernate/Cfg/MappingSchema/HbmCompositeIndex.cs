...
// Type: NHibernate.Cfg.MappingSchema.HbmCompositeIndex
...
{
  [XmlRoot("composite-index", Namespace = "urn:nhibernate-mapping-2.2", IsNullable = false)]
  [GeneratedCode("HbmXsd", "3.2.0.1001")]
  [DebuggerStepThrough]
  [DesignerCategory("code")]
  [XmlType(AnonymousType = true, Namespace = "urn:nhibernate-mapping-2.2")]
  [Serializable]
  public class HbmCompositeIndex : IComponentMapping, IPropertiesContainerMapping
  {
