...
// Type: NHibernate.Criterion.Lambda.IQueryOverJoinBuilder`2
...
namespace NHibernate.Criterion.Lambda
{
  public class IQueryOverJoinBuilder<TRoot, TSubType>(
    ...
    JoinType joinType) : QueryOverJoinBuilderBase<IQueryOver<TRoot, TSubType>, TRoot, TSubType>(root, joinType)
  {
    ...
    public IQueryOver<TRoot, U> JoinQueryOver<U>(
