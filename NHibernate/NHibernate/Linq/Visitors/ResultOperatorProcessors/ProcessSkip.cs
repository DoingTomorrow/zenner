...
// Type: NHibernate.Linq.Visitors.ResultOperatorProcessors.ProcessSkip
  ...
  public class ProcessSkip : IResultOperatorProcessor<SkipResultOperator>
  {
      ...
      IntermediateHqlTree tree)
    {
      ...
      if (visitorParameters.ConstantToParameterMap.TryGetValue(resultOperator.Count as ConstantExpression, out namedParameter))
      {
        ...
        tree.AddSkipClause((HqlExpression) tree.TreeBuilder.Parameter(namedParameter.Name));
      }
      else
        tree.AddSkipClause((HqlExpression) tree.TreeBuilder.Constant((object) resultOperator.GetConstantCount()));
    }
  }
}
