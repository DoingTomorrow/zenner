...
// Type: NHibernate.Mapping.ByCode.Impl.CustomizersImpl.BagPropertiesCustomizer`2
...
{
  public class BagPropertiesCustomizer<TEntity, TElement> : 
    CollectionPropertiesCustomizer<TEntity, TElement>,
    IBagPropertiesMapper<TEntity, TElement>,
    ...
    where TEntity : class
  {
    public BagPropertiesCustomizer(
