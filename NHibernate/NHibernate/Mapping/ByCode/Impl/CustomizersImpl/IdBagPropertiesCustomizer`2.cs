...
// Type: NHibernate.Mapping.ByCode.Impl.CustomizersImpl.IdBagPropertiesCustomizer`2
...
{
  public class IdBagPropertiesCustomizer<TEntity, TElement> : 
    CollectionPropertiesCustomizer<TEntity, TElement>,
    IIdBagPropertiesMapper<TEntity, TElement>,
    ...
    where TEntity : class
  {
    public IdBagPropertiesCustomizer(
    ...
    {
      this.CustomizersHolder.AddCustomizer(this.PropertyPath, (Action<IIdBagPropertiesMapper>) (x => x.Id(idMapping)));
    }
  }
}
