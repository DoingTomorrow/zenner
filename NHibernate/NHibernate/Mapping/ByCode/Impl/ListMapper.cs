...
// Type: NHibernate.Mapping.ByCode.Impl.ListMapper
...
namespace NHibernate.Mapping.ByCode.Impl
{
    ...
    ICollectionSqlsMapper
  {
      ...
      HbmList mapping)
    {
      ...
      HbmListIndex mapping1 = new HbmListIndex();
      mapping.Item = (object) mapping1;
      this.listIndexMapper = (IListIndexMapper) new ListIndexMapper(ownerType, mapping1);
    ...
    {
      listIndexMapping(this.listIndexMapper);
    }
