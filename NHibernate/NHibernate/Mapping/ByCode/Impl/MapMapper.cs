...
// Type: NHibernate.Mapping.ByCode.Impl.MapMapper
...
namespace NHibernate.Mapping.ByCode.Impl
{
    ...
    ICollectionSqlsMapper
  {
    ...
    public MapMapper(
      ...
      HbmMap mapping,
      HbmMapping mapDoc)
      : this(ownerType, keyType, valueType, (IAccessorPropertyMapper) new AccessorPropertyMapper(ownerType, mapping.Name, (Action<string>) (x => mapping.access = x)), mapping, mapDoc)
    {
    }
      ...
      HbmMapping mapDoc)
    {
      ...
      if (this.KeyType.IsValueType || this.KeyType == typeof (string))
        mapping.Item = (object) new HbmMapKey()
        {
          type = this.KeyType.GetNhTypeName()
        };
      else
        mapping.Item = (object) new HbmMapKeyManyToMany()
        {
          @class = this.KeyType.GetShortClassName(mapDoc)
        };
    ...
    public void Sort() => this.mapping.sort = "natural";
