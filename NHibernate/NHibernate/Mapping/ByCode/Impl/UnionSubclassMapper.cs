...
// Type: NHibernate.Mapping.ByCode.Impl.UnionSubclassMapper
...
{
  public class UnionSubclassMapper : 
    AbstractPropertyContainerMapper,
    IUnionSubclassMapper,
    IUnionSubclassAttributesMapper,
    ...
    IMinimalPlainPropertyContainerMapper
  {
    ...
    {
      this.classMapping = new HbmUnionSubclass();
      HbmUnionSubclass[] second = new HbmUnionSubclass[1]
      {
        this.classMapping
      };
