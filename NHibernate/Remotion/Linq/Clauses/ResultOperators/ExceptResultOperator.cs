...
namespace Remotion.Linq.Clauses.ResultOperators
{
  public class ExceptResultOperator : SequenceTypePreservingResultOperatorBase
  {
    ...
    {
      return new StreamedSequence((IEnumerable) input.GetTypedSequence<T>().Except<T>((IEnumerable<T>) this.GetConstantSource2()).AsQueryable<T>(), (StreamedSequenceInfo) this.GetOutputDataInfo((IStreamedDataInfo) input.DataInfo));
    }
    ...
    {
      return "Except(" + FormattingExpressionTreeVisitor.Format(this.Source2) + ")";
    }
  }
}
