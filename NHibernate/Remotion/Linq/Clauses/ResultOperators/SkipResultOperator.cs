...
namespace Remotion.Linq.Clauses.ResultOperators
{
  public class SkipResultOperator : SequenceTypePreservingResultOperatorBase
  {
    ...
    {
      return new StreamedSequence((IEnumerable) input.GetTypedSequence<T>().Skip<T>(this.GetConstantCount()).AsQueryable<T>(), (StreamedSequenceInfo) this.GetOutputDataInfo((IStreamedDataInfo) input.DataInfo));
    }
    ...
    {
      return "Skip(" + FormattingExpressionTreeVisitor.Format(this.Count) + ")";
    }
  }
}
