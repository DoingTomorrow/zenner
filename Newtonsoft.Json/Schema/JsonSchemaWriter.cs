  ...
  internal class JsonSchemaWriter
  {
    ...
    private void WriteType(string propertyName, JsonWriter writer, JsonSchemaType type)
    {
      ...
      if (Enum.IsDefined(typeof (JsonSchemaType), (object) type))
        ...
        jsonSchemaTypeList = (IList<JsonSchemaType>) EnumUtils.GetFlagsValues<JsonSchemaType>(type).Where<JsonSchemaType>((Func<JsonSchemaType, bool>) (v => v != 0)).ToList<JsonSchemaType>();
