...
namespace Newtonsoft.Json.Utilities
{
  internal sealed class DynamicProxyMetaObject<T> : DynamicMetaObject
  {
    ...
    {
      return !this.IsOverridden("TryGetMember") ? base.BindGetMember(binder) : this.CallMethodWithResult("TryGetMember", (DynamicMetaObjectBinder) binder, DynamicProxyMetaObject<T>.NoArgs, (DynamicProxyMetaObject<T>.Fallback) (e => binder.FallbackGetMember((DynamicMetaObject) this, e)));
    }
    ...
    {
      return !this.IsOverridden("TryConvert") ? base.BindConvert(binder) : this.CallMethodWithResult("TryConvert", (DynamicMetaObjectBinder) binder, DynamicProxyMetaObject<T>.NoArgs, (DynamicProxyMetaObject<T>.Fallback) (e => binder.FallbackConvert((DynamicMetaObject) this, e)));
    }
    ...
    {
      return (Expression[]) ((IEnumerable<DynamicMetaObject>) args).Select<DynamicMetaObject, UnaryExpression>((Func<DynamicMetaObject, UnaryExpression>) (arg => Expression.Convert(arg.Expression, typeof (object)))).ToArray<UnaryExpression>();
    }
      ...
      DynamicProxyMetaObject<T>.Fallback fallback)
    {
      ...
      expressionList.Add((Expression) DynamicProxyMetaObject<T>.Constant(binder));
      expressionList.AddRange<Expression>((IEnumerable<Expression>) args);
      expressionList[args.Length + 1] = (Expression) Expression.Assign((Expression) parameterExpression, expressionList[args.Length + 1]);
    ...
    {
      return (object) this.Value != null || !this.HasValue ? BindingRestrictions.GetTypeRestriction(this.Expression, this.LimitType) : BindingRestrictions.GetInstanceRestriction(this.Expression, (object) null);
    }
