...
// Type: PDCL2_Handler.NominalFlow
...
namespace PDCL2_Handler
{
  public class NominalFlow
  {
    ...
    public string GetNominalFlow()
    {
      ...
      {
        if (this.OversizeDiff == (ushort) 62 && this.UndersizeDiff == (ushort) 625 && this.BurstDiff == (ushort) 187)
          return 2.5.ToString();
        if (this.OversizeDiff == (ushort) 100 && this.UndersizeDiff == (ushort) 1000 && this.BurstDiff == (ushort) 300)
          return 4.ToString();
        if (this.OversizeDiff == (ushort) 157 && this.UndersizeDiff == (ushort) 1575 && this.BurstDiff == (ushort) 472)
          return 6.3.ToString();
    ...
    public void SetNominalFlow(string value)
    {
      ...
      if (this.PulseMultiplier == (byte) 1)
      {
        ...
        if (num.ToString() == value)
          this.Set((ushort) 62, (ushort) 625, (ushort) 187);
        if (4.ToString() == value)
          this.Set((ushort) 100, (ushort) 1000, (ushort) 300);
        num = 6.3;
        if (num.ToString() == value)
          this.Set((ushort) 157, (ushort) 1575, (ushort) 472);
