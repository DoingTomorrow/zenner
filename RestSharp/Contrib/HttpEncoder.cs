...
// Type: RestSharp.Contrib.HttpEncoder
...
namespace RestSharp.Contrib
{
  internal class HttpEncoder
  {
    ...
    public static HttpEncoder Current => HttpEncoder.currentEncoder;

    public static HttpEncoder Default => HttpEncoder.defaultEncoder;

    internal static void HeaderNameValueEncode(
      string headerName,
      string headerValue,
          ...
          for (int index = 0; index < length; ++index)
          {
            switch (s[index])
            {
              ...
              default:
                ...
                {
                  stringBuilder.Append("&#");
                  stringBuilder.Append(((int) ch).ToString((IFormatProvider) Helpers.InvariantCulture));
                  stringBuilder.Append(";");
                  break;
                }
        ...
        default:
          ...
          for (int index = 0; index < length; ++index)
          {
            ...
            else if (ch == '&')
            {
              ...
              if (flag2)
              {
                stringBuilder1.Append(num2.ToString((IFormatProvider) Helpers.InvariantCulture));
                flag2 = false;
              }
                ...
                case 3:
                  if (ch == ';')
                  {
                    if (num2 > (int) ushort.MaxValue)
                    {
                      ...
                      stringBuilder2.Append(num2.ToString((IFormatProvider) Helpers.InvariantCulture));
                      stringBuilder2.Append(";");
                    }
                    else
