...
namespace RestSharp
{
  internal class SimpleJson
  {
    ...
    {
      object @object;
      if (SimpleJson.TryDeserializeObject(json, out @object))
        return @object;
    ...
    public static bool TryDeserializeObject(string json, out object @object)
    {
      ...
      if (json != null)
      {
        ...
        int index = 0;
        @object = SimpleJson.ParseValue(charArray, ref index, ref success);
      }
      else
        @object = (object) null;
      return success;
      ...
      IJsonSerializerStrategy jsonSerializerStrategy)
    {
      ...
      return !(type == (Type) null) && (obj == null || !obj.GetType().IsAssignableFrom(type)) ? (jsonSerializerStrategy ?? SimpleJson.CurrentJsonSerializerStrategy).DeserializeObject(obj, type) : obj;
    }
              ...
              switch (json[index++])
              {
                ...
                case 'u':
                  if (json.Length - index >= 4)
                  {
                    ...
                    stringBuilder.Append(char.ConvertFromUtf32((int) result1));
                    index += 4;
                    continue;
                  }
                  goto label_23;
...
label_23:
    ...
    public static IJsonSerializerStrategy CurrentJsonSerializerStrategy
    {
      get
      {
        return SimpleJson.currentJsonSerializerStrategy ?? (SimpleJson.currentJsonSerializerStrategy = (IJsonSerializerStrategy) SimpleJson.PocoJsonSerializerStrategy);
      }
      set => SimpleJson.currentJsonSerializerStrategy = value;
    }
    ...
    public static PocoJsonSerializerStrategy PocoJsonSerializerStrategy
    {
      get
      {
        return SimpleJson.pocoJsonSerializerStrategy ?? (SimpleJson.pocoJsonSerializerStrategy = new PocoJsonSerializerStrategy());
      }
    }
  }
}
