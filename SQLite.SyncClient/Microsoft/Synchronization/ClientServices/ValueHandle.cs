...
namespace Microsoft.Synchronization.ClientServices
{
  public class ValueHandle
  {
    ...
    public void SetValue(ValueHandleType valueHandleType) => this.type = valueHandleType;

    public void SetDictionaryValue(int key) => this.SetValue(ValueHandleType.Dictionary, key, 0);

    public void SetCharValue(int ch) => this.SetValue(ValueHandleType.Char, ch, 0);
    ...
    public bool IsWhitespace()
    {
      switch (this.type)
      {
        ...
        case ValueHandleType.Char:
          ...
          return num <= (int) ushort.MaxValue && XmlConverter.IsWhitespace((char) num);
    ...
    public int ToInt()
    {
      ...
      return type == ValueHandleType.UTF8 ? XmlConverter.ToInt32(this.bufferReader.Buffer, this.offset, this.length) : XmlConverter.ToInt32(this.GetString());
    }
    ...
    public ulong ToULong()
    {
      ...
      switch (type)
      {
        ...
        default:
          ...
          return type == ValueHandleType.UTF8 ? XmlConverter.ToUInt64(this.bufferReader.Buffer, this.offset, this.length) : XmlConverter.ToUInt64(this.GetString());
      }
    }
    ...
    public float ToSingle()
    {
      ...
      return type == ValueHandleType.UTF8 ? XmlConverter.ToSingle(this.bufferReader.Buffer, this.offset, this.length) : XmlConverter.ToSingle(this.GetString());
    }
    ...
    public Decimal ToDecimal()
    {
      ...
      switch (type)
      {
        ...
        default:
          ...
          return type == ValueHandleType.UTF8 ? XmlConverter.ToDecimal(this.bufferReader.Buffer, this.offset, this.length) : XmlConverter.ToDecimal(this.GetString());
      }
    }
    ...
    public DateTime ToDateTime()
    {
      ...
      return this.type == ValueHandleType.UTF8 ? XmlConverter.ToDateTime(this.bufferReader.Buffer, this.offset, this.length) : XmlConverter.ToDateTime(this.GetString());
    }
    ...
    public UniqueId ToUniqueId()
    {
      ...
      return this.type == ValueHandleType.UTF8 ? XmlConverter.ToUniqueId(this.bufferReader.Buffer, this.offset, this.length) : XmlConverter.ToUniqueId(this.GetString());
    }
    ...
    public TimeSpan ToTimeSpan()
    {
      ...
      return this.type == ValueHandleType.UTF8 ? XmlConverter.ToTimeSpan(this.bufferReader.Buffer, this.offset, this.length) : XmlConverter.ToTimeSpan(this.GetString());
    }
    ...
    public Guid ToGuid()
    {
      if (this.type == ValueHandleType.Guid)
        return this.GetGuid();
      return this.type == ValueHandleType.UTF8 ? XmlConverter.ToGuid(this.bufferReader.Buffer, this.offset, this.length) : XmlConverter.ToGuid(this.GetString());
    }
    ...
    public bool Equals2(string str, bool checkLower)
    {
      ...
      {
        byte c = buffer[index + this.offset];
        if ((int) c != (int) str[index] && (!checkLower || (int) char.ToLowerInvariant((char) c) != (int) str[index]))
          return false;
      }
      return true;
    }
    ...
    private string GetCharsText() => this.bufferReader.GetString(this.offset, this.length);
    ...
    private int GetChar() => this.offset;

    private int GetInt8() => this.bufferReader.GetInt8(this.offset);

    private int GetInt16() => this.bufferReader.GetInt16(this.offset);

    private int GetInt32() => this.bufferReader.GetInt32(this.offset);

    private long GetInt64() => this.bufferReader.GetInt64(this.offset);

    private ulong GetUInt64() => this.bufferReader.GetUInt64(this.offset);

    private float GetSingle() => this.bufferReader.GetSingle(this.offset);

    private double GetDouble() => this.bufferReader.GetDouble(this.offset);

    private Decimal GetDecimal() => this.bufferReader.GetDecimal(this.offset);

    private UniqueId GetUniqueId() => this.bufferReader.GetUniqueId(this.offset);

    private Guid GetGuid() => this.bufferReader.GetGuid(this.offset);
