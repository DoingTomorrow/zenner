...
namespace SQLite
{
  public static class SQLite3
  {
    ...
    [DllImport("sqlite3", EntryPoint = "sqlite3_win32_set_directory", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
    ...
    {
      IntPtr stmt;
      SQLite3.Result r = SQLite3.Prepare2(db, query, Encoding.UTF8.GetByteCount(query), out stmt, IntPtr.Zero);
      if (r != 0)
