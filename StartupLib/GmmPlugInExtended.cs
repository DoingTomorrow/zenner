...
// Type: StartupLib.GmmPlugInExtended
...
{
  public abstract class GmmPlugInExtended : GmmPlugIn
  {
    public abstract string ShowMainWindow(GmmPlugInExtendedOptions options, object parameter = null);
  }
}
