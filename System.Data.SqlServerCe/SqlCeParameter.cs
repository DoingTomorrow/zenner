      ...
      get
      {
        if (this.precision == (byte) 0 && this.SqlDbType == SqlDbType.Decimal)
        {
          ...
          if (obj != null && obj != DBNull.Value && (!(obj is INullable) || !((INullable) obj).IsNull))
          {
            ...
            {
              case Decimal num:
                sqlDecimal = new SqlDecimal(num);
                goto label_5;
              case SqlDecimal sqlDecimal:
label_5:
                return sqlDecimal.Precision;
              default:
                sqlDecimal = (SqlDecimal) ((IConvertible) obj).ToDecimal((IFormatProvider) null);
                goto label_5;
            }
          }
        }
...
label_5:
    ...
    private void ConvertValue()
    {
      ...
      {
        if (this.typeMap.clrType == typeof (string))
        {
        ...
        else if (this.value is INullable && ((INullable) this.value).IsNull)
        {
