...
namespace System.Data.SqlServerCe
{
  public sealed class SqlCeParameterCollection : DbParameterCollection
  {
    ...
    {
      throw new IndexOutOfRangeException(Res.GetString("ADP_CollectionIndexString", (object) this.ItemType.Name, (object) "ParameterName", (object) parameterName, (object) this.GetType().Name));
    }

    private Exception ThrowParamterNotFoundException(int index)
    {
      throw new IndexOutOfRangeException(Res.GetString("ADP_CollectionIndexString", (object) this.ItemType.Name, (object) "ParameterIndex", (object) index.ToString((IFormatProvider) CultureInfo.InvariantCulture), (object) this.GetType().Name));
    }
    ...
    {
      this[index] = (SqlCeParameter) value;
    }

    protected override void SetParameter(string parameterName, DbParameter value)
    {
      this[parameterName] = (SqlCeParameter) value;
    }
    ...
    {
      return this.Add(new SqlCeParameter(parameterName, value));
    }
    ...
    {
      return this.Add(new SqlCeParameter(parameterName, type));
    }

    public SqlCeParameter Add(string parameterName, SqlDbType type, int size)
    {
      return this.Add(new SqlCeParameter(parameterName, type, size));
    }
    ...
    {
      return !string.IsNullOrEmpty(value) && this.m_KeyValuePairs != null && this.m_KeyValuePairs.ContainsKey(value.StartsWith("@") ? value.Substring(1) : value);
    }
    ...
    {
      ((ICollection) this.InitCollections()).CopyTo(array, index);
    }

    public override IEnumerator GetEnumerator()
    {
      return (IEnumerator) this.InitCollections().GetEnumerator();
    }
