...
namespace System.Data.SqlServerCe
{
  public class SqlCeUpdatableRecord : IDataRecord
  {
    ...
    public int GetValues(object[] values)
    {
      ...
      int num = values.Length < this.sqlMetaDatas.Length ? values.Length : this.sqlMetaDatas.Length;
      int values1 = num < this.values.Length ? num : this.values.Length;
      for (int index = 0; index < values1; ++index)
      {
        object obj = this.values[index];
        values[index] = !(obj is SqlDecimal sqlDecimal) ? obj : (object) (Decimal) sqlDecimal;
      }
      return values1;
    }
    ...
    {
      return SqlCeType.FromSqlDbType(this.sqlMetaDatas[ordinal].SqlDbType).clrType;
    }

    public IDataReader GetData(int ordinal)
    {
      throw new NotSupportedException(string.Format((IFormatProvider) CultureInfo.InvariantCulture, nameof (GetData)));
    }
    ...
    {
      return ColumnUpdatedStatus.ServerDefault == this.columnsUpdated[ordinal];
    }
    ...
    {
      return !this.IsDBNull(ordinal) ? (bool) this.values[ordinal] : throw new SqlNullValueException();
    }

    public byte GetByte(int ordinal)
    {
      return !this.IsDBNull(ordinal) ? (byte) this.values[ordinal] : throw new SqlNullValueException();
    }

    public long GetBytes(int ordinal, long dataIndex, byte[] buffer, int bufferIndex, int length)
    {
      byte[] sourceArray = !this.IsDBNull(ordinal) ? (byte[]) this.values[ordinal] : throw new SqlNullValueException();
      if (buffer == null)
        return (long) sourceArray.Length;
      if ((int) dataIndex > sourceArray.Length || sourceArray.Length == 0)
        return 0;
      if (dataIndex < 0L)
      ...
      int num2 = (int) ((long) sourceArray.Length - dataIndex);
      ...
      if ((long) sourceArray.Length - dataIndex < (long) length1)
        length1 = sourceArray.Length - (int) dataIndex;
      if (length1 < 0)
      ...
      Array.Copy((Array) sourceArray, (int) dataIndex, (Array) buffer, bufferIndex, length1);
      return (long) length1;
    }

    public long GetChars(int ordinal, long dataIndex, char[] buffer, int bufferIndex, int length)
    {
      char[] sourceArray = !this.IsDBNull(ordinal) ? ((string) this.values[ordinal]).ToCharArray() : throw new SqlNullValueException();
      if (buffer == null)
        return (long) sourceArray.Length;
      if ((int) dataIndex > sourceArray.Length || sourceArray.Length == 0)
        return 0;
    ...
    {
      return !this.IsDBNull(ordinal) ? (Guid) this.values[ordinal] : throw new SqlNullValueException();
    }

    public short GetInt16(int ordinal)
    {
      return !this.IsDBNull(ordinal) ? (short) this.values[ordinal] : throw new SqlNullValueException();
    }

    public int GetInt32(int ordinal)
    {
      return !this.IsDBNull(ordinal) ? (int) this.values[ordinal] : throw new SqlNullValueException();
    }

    public long GetInt64(int ordinal)
    {
      return !this.IsDBNull(ordinal) ? (long) this.values[ordinal] : throw new SqlNullValueException();
    }

    public float GetFloat(int ordinal)
    {
      return !this.IsDBNull(ordinal) ? (float) this.values[ordinal] : throw new SqlNullValueException();
    }

    public double GetDouble(int ordinal)
    {
      return !this.IsDBNull(ordinal) ? (double) this.values[ordinal] : throw new SqlNullValueException();
    }
    ...
    {
      return !this.IsDBNull(ordinal) ? this.GetSqlDecimal(ordinal).Value : throw new SqlNullValueException();
    }

    public DateTime GetDateTime(int ordinal)
    {
      return !this.IsDBNull(ordinal) ? (DateTime) this.values[ordinal] : throw new SqlNullValueException();
    }
    ...
    {
      return this.IsDBNull(ordinal) ? SqlMoney.Null : new SqlMoney(this.GetSqlDecimal(ordinal).Value);
    }
    ...
    public SqlDecimal GetSqlDecimal(int ordinal)
    {
      ...
      return (SqlDecimal) this.values[ordinal];
    }
    ...
    {
      throw new NotSupportedException(string.Format((IFormatProvider) CultureInfo.InvariantCulture, nameof (SetChar)));
    }
