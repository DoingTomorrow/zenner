...
namespace System.Data.SqlServerCe
{
  public sealed class SqlMetaData
  {
    ...
    public SqlBinary Adjust(SqlBinary value)
    {
      if (SqlDbType.Binary == this.SqlDbType || SqlDbType.Timestamp == this.SqlDbType)
      {
        if (!value.IsNull && (long) value.Length < this.MaxLength)
        {
          ...
          Array.Clear((Array) destinationArray, sourceArray.Length, destinationArray.Length - sourceArray.Length);
      ...
      if (value.IsNull || (long) value.Length <= this.MaxLength || SqlMetaData.Max == this.MaxLength)
        return value;
      byte[] sourceArray1 = value.Value;
      byte[] destinationArray1 = new byte[this.MaxLength];
      Array.Copy((Array) sourceArray1, (Array) destinationArray1, (int) this.MaxLength);
      value = new SqlBinary(destinationArray1);
      return value;
    }
        ...
        if (value != null && !value.IsNull)
        {
          ...
          if (length < this.MaxLength)
          {
            if (value.MaxLength < this.MaxLength)
            {
              ...
              Array.Copy((Array) value.Buffer, (Array) chArray, (int) length);
              value = new SqlChars(chArray);
            }
        ...
        if (value != null && !value.IsNull)
        {
          ...
          if ((long) length < this.MaxLength)
          {
            if (value.MaxLength < this.MaxLength)
            {
              ...
              Array.Copy((Array) value.Buffer, (Array) numArray, length);
              value = new SqlBytes(numArray);
            }
            byte[] buffer = value.Buffer;
            Array.Clear((Array) buffer, length, buffer.Length - length);
            value.SetLength(this.MaxLength);
            return value;
          }
        }
    ...
    public byte[] Adjust(byte[] value)
    {
      if (SqlDbType.Binary == this.SqlDbType || SqlDbType.Timestamp == this.SqlDbType)
      {
        if (value != null && (long) value.Length < this.MaxLength)
        {
          ...
          Array.Clear((Array) destinationArray, value.Length, destinationArray.Length - value.Length);
      ...
      {
        byte[] destinationArray = new byte[this.MaxLength];
        Array.Copy((Array) value, (Array) destinationArray, (int) this.MaxLength);
    ...
    public char[] Adjust(char[] value)
    {
      if (SqlDbType.Char == this.SqlDbType || SqlDbType.NChar == this.SqlDbType)
      {
        if (value != null)
        {
          ...
          if (length < this.MaxLength)
          {
            ...
            Array.Copy((Array) value, (Array) destinationArray, (int) length);
            for (long index = length; index < (long) destinationArray.Length; ++index)
      ...
      if ((long) value.Length > this.MaxLength && SqlMetaData.Max != this.MaxLength)
      {
        char[] destinationArray = new char[this.MaxLength];
        Array.Copy((Array) value, (Array) destinationArray, (int) this.MaxLength);
        value = destinationArray;
      }
      return value;
    ...
    {
      throw new ArgumentException(string.Format((IFormatProvider) CultureInfo.InvariantCulture, "invalid type"));
    }
    ...
    {
      return !value.IsNull && ((int) value.Precision != (int) this.Precision || (int) value.Scale != (int) this.Scale) ? SqlDecimal.ConvertToPrecScale(value, (int) this.Precision, (int) this.Scale) : value;
    }
