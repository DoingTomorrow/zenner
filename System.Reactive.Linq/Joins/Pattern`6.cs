...
// Type: System.Reactive.Joins.Pattern`6
...
namespace System.Reactive.Joins
{
  public class Pattern<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6> : Pattern
  {
      ...
      IObservable<TSource7> other)
    {
      ...
      return new Pattern<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7>(this.First, this.Second, this.Third, this.Fourth, this.Fifth, this.Sixth, other);
    }

    public Plan<TResult> Then<TResult>(
      Func<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TResult> selector)
    {
      return selector != null ? (Plan<TResult>) new Plan<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TResult>(this, selector) : throw new ArgumentNullException(nameof (selector));
    }
  }
}
