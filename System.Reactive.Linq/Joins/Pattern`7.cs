...
// Type: System.Reactive.Joins.Pattern`7
...
{
  public class Pattern<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7> : 
    Pattern
  {
    internal Pattern(
      ...
      IObservable<TSource8> other)
    {
      ...
      return new Pattern<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7, TSource8>(this.First, this.Second, this.Third, this.Fourth, this.Fifth, this.Sixth, this.Seventh, other);
    }

    public Plan<TResult> Then<TResult>(
      Func<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7, TResult> selector)
    {
      return selector != null ? (Plan<TResult>) new Plan<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7, TResult>(this, selector) : throw new ArgumentNullException(nameof (selector));
    }
  }
}
