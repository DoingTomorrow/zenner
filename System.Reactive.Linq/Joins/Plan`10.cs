...
// Type: System.Reactive.Joins.Plan`10
...
namespace System.Reactive.Joins
{
  internal class Plan<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> : Plan<TResult>
  {
    ...
    internal Plan(
      Pattern<T1, T2, T3, T4, T5, T6, T7, T8, T9> expression,
      ...
      Action<ActivePlan> deactivate)
    {
      ...
      ActivePlan<T1, T2, T3, T4, T5, T6, T7, T8, T9> activePlan = (ActivePlan<T1, T2, T3, T4, T5, T6, T7, T8, T9>) null;
      activePlan = new ActivePlan<T1, T2, T3, T4, T5, T6, T7, T8, T9>(firstJoinObserver, secondJoinObserver, thirdJoinObserver, fourthJoinObserver, fifthJoinObserver, sixthJoinObserver, seventhJoinObserver, eighthJoinObserver, ninthJoinObserver, (Action<T1, T2, T3, T4, T5, T6, T7, T8, T9>) ((first, second, third, fourth, fifth, sixth, seventh, eighth, ninth) =>
      {
        TResult result1 = default (TResult);
        TResult result2;
        try
        {
          result2 = this.Selector(first, second, third, fourth, fifth, sixth, seventh, eighth, ninth);
        }
        catch (Exception ex)
        {
          observer.OnError(ex);
