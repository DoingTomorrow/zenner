...
// Type: System.Reactive.Joins.Plan`6
...
namespace System.Reactive.Joins
{
  internal class Plan<T1, T2, T3, T4, T5, TResult> : Plan<TResult>
  {
    ...
    internal Plan(
      Pattern<T1, T2, T3, T4, T5> expression,
      ...
      Action<ActivePlan> deactivate)
    {
      ...
      ActivePlan<T1, T2, T3, T4, T5> activePlan = (ActivePlan<T1, T2, T3, T4, T5>) null;
      activePlan = new ActivePlan<T1, T2, T3, T4, T5>(firstJoinObserver, secondJoinObserver, thirdJoinObserver, fourthJoinObserver, fifthJoinObserver, (Action<T1, T2, T3, T4, T5>) ((first, second, third, fourth, fifth) =>
      {
        TResult result1 = default (TResult);
        TResult result2;
        try
        {
          result2 = this.Selector(first, second, third, fourth, fifth);
        }
        catch (Exception ex)
        {
          observer.OnError(ex);
