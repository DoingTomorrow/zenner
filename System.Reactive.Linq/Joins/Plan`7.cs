...
// Type: System.Reactive.Joins.Plan`7
...
namespace System.Reactive.Joins
{
  internal class Plan<T1, T2, T3, T4, T5, T6, TResult> : Plan<TResult>
  {
    ...
    internal Plan(
      Pattern<T1, T2, T3, T4, T5, T6> expression,
      ...
      Action<ActivePlan> deactivate)
    {
      ...
      ActivePlan<T1, T2, T3, T4, T5, T6> activePlan = (ActivePlan<T1, T2, T3, T4, T5, T6>) null;
      activePlan = new ActivePlan<T1, T2, T3, T4, T5, T6>(firstJoinObserver, secondJoinObserver, thirdJoinObserver, fourthJoinObserver, fifthJoinObserver, sixthJoinObserver, (Action<T1, T2, T3, T4, T5, T6>) ((first, second, third, fourth, fifth, sixth) =>
      {
        TResult result1 = default (TResult);
        TResult result2;
        try
        {
          result2 = this.Selector(first, second, third, fourth, fifth, sixth);
        }
        catch (Exception ex)
        {
          observer.OnError(ex);
