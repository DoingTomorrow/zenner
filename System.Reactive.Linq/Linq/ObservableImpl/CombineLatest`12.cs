...
// Type: System.Reactive.Linq.ObservableImpl.CombineLatest`12
...
namespace System.Reactive.Linq.ObservableImpl
{
    ...
    Producer<TResult>
  {
    ...
    {
      CombineLatest<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>._ obj = new CombineLatest<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>._(this, observer, cancel);
    ...
    private class _ : CombineLatestSink<TResult>
    {
      ...
      public _(
        CombineLatest<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult> parent,
        IObserver<TResult> observer,
        IDisposable cancel)
      ...
      {
        SingleAssignmentDisposable[] assignmentDisposableArray = new SingleAssignmentDisposable[11];
      ...
      {
        return this._parent._resultSelector(this._observer1.Value, this._observer2.Value, this._observer3.Value, this._observer4.Value, this._observer5.Value, this._observer6.Value, this._observer7.Value, this._observer8.Value, this._observer9.Value, this._observer10.Value, this._observer11.Value);
      }
    }
  }
}
