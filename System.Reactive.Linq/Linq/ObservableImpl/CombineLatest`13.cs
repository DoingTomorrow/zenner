...
// Type: System.Reactive.Linq.ObservableImpl.CombineLatest`13
...
namespace System.Reactive.Linq.ObservableImpl
{
    ...
    Producer<TResult>
  {
    ...
    {
      CombineLatest<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>._ obj = new CombineLatest<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>._(this, observer, cancel);
    ...
    private class _ : CombineLatestSink<TResult>
    {
      ...
      public _(
        CombineLatest<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> parent,
        IObserver<TResult> observer,
        IDisposable cancel)
      ...
      {
        SingleAssignmentDisposable[] assignmentDisposableArray = new SingleAssignmentDisposable[12];
