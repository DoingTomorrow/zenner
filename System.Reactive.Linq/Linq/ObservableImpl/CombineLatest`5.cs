...
// Type: System.Reactive.Linq.ObservableImpl.CombineLatest`5
...
{
  internal class CombineLatest<T1, T2, T3, T4, TResult> : Producer<TResult>
  {
    ...
    {
      CombineLatest<T1, T2, T3, T4, TResult>._ obj = new CombineLatest<T1, T2, T3, T4, TResult>._(this, observer, cancel);
    ...
    private class _ : CombineLatestSink<TResult>
    {
      ...
      public _(
        CombineLatest<T1, T2, T3, T4, TResult> parent,
        IObserver<TResult> observer,
        IDisposable cancel)
      ...
      {
        return this._parent._resultSelector(this._observer1.Value, this._observer2.Value, this._observer3.Value, this._observer4.Value);
      }
    }
  }
}
