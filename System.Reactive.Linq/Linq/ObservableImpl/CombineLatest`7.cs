...
// Type: System.Reactive.Linq.ObservableImpl.CombineLatest`7
...
{
  internal class CombineLatest<T1, T2, T3, T4, T5, T6, TResult> : Producer<TResult>
  {
    ...
    {
      CombineLatest<T1, T2, T3, T4, T5, T6, TResult>._ obj = new CombineLatest<T1, T2, T3, T4, T5, T6, TResult>._(this, observer, cancel);
    ...
    private class _ : CombineLatestSink<TResult>
    {
      ...
      public _(
        CombineLatest<T1, T2, T3, T4, T5, T6, TResult> parent,
        IObserver<TResult> observer,
        IDisposable cancel)
      ...
      {
        SingleAssignmentDisposable[] assignmentDisposableArray = new SingleAssignmentDisposable[6];
      ...
      {
        return this._parent._resultSelector(this._observer1.Value, this._observer2.Value, this._observer3.Value, this._observer4.Value, this._observer5.Value, this._observer6.Value);
      }
    }
  }
}
