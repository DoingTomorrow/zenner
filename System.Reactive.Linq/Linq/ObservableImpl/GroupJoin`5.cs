...
// Type: System.Reactive.Linq.ObservableImpl.GroupJoin`5
  ...
  internal class GroupJoin<TLeft, TRight, TLeftDuration, TRightDuration, TResult> : Producer<TResult>
  {
    ...
    private class _ : Sink<TResult>
    {
      ...
      public IDisposable Run()
      {
        ...
        self1.Disposable = this._parent._left.SubscribeSafe<TLeft>((IObserver<TLeft>) new GroupJoin<TLeft, TRight, TLeftDuration, TRightDuration, TResult>._.LeftObserver(this, (IDisposable) self1));
        self2.Disposable = this._parent._right.SubscribeSafe<TRight>((IObserver<TRight>) new GroupJoin<TLeft, TRight, TLeftDuration, TRightDuration, TResult>._.RightObserver(this, (IDisposable) self2));
      ...
      private class LeftObserver : IObserver<TLeft>
      {
        ...
        public void OnNext(TLeft value)
        {
          ...
          lock (this._parent._gate)
          {
            ...
            this._parent._leftMap.Add(num1, (IObserver<TRight>) subject);
          }
          ...
          self.Disposable = source.SubscribeSafe<TLeftDuration>((IObserver<TLeftDuration>) new GroupJoin<TLeft, TRight, TLeftDuration, TRightDuration, TResult>._.LeftObserver.Delta(this, num1, (IObserver<TRight>) subject, (IDisposable) self));
        ...
        public void OnError(Exception error)
        {
          lock (this._parent._gate)
          {
            foreach (KeyValuePair<int, IObserver<TRight>> left in this._parent._leftMap)
              left.Value.OnError(error);
        ...
        private class Delta : IObserver<TLeftDuration>
        {
          ...
          public Delta(
            GroupJoin<TLeft, TRight, TLeftDuration, TRightDuration, TResult>._.LeftObserver parent,
            int id,
      ...
      private class RightObserver : IObserver<TRight>
      {
        ...
        public void OnNext(TRight value)
        {
          ...
          self.Disposable = source.SubscribeSafe<TRightDuration>((IObserver<TRightDuration>) new GroupJoin<TLeft, TRight, TLeftDuration, TRightDuration, TResult>._.RightObserver.Delta(this, num1, (IDisposable) self));
          lock (this._parent._gate)
          {
            foreach (KeyValuePair<int, IObserver<TRight>> left in this._parent._leftMap)
            {
              if (left.Key < num2)
                left.Value.OnNext(value);
            }
          }
        }
        ...
        private class Delta : IObserver<TRightDuration>
        {
          ...
          public Delta(
            GroupJoin<TLeft, TRight, TLeftDuration, TRightDuration, TResult>._.RightObserver parent,
            int id,
            IDisposable self)
          {
            this._parent = parent;
