...
// Type: System.Reactive.Linq.ObservableImpl.MaxBy`2
...
{
  internal class MaxBy<TSource, TKey> : Producer<IList<TSource>>
  {
    ...
    {
      MaxBy<TSource, TKey>._ obj = new MaxBy<TSource, TKey>._(this, observer, cancel);
