...
// Type: System.Reactive.Linq.ObservableImpl.MaxDecimalNullable
...
{
  internal class MaxDecimalNullable : Producer<Decimal?>
  {
    private readonly IObservable<Decimal?> _source;

    public MaxDecimalNullable(IObservable<Decimal?> source) => this._source = source;
    ...
    {
      MaxDecimalNullable._ obj = new MaxDecimalNullable._(observer, cancel);
