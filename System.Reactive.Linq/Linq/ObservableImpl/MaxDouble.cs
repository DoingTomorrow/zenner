...
// Type: System.Reactive.Linq.ObservableImpl.MaxDouble
...
{
  internal class MaxDouble : Producer<double>
  {
    private readonly IObservable<double> _source;

    public MaxDouble(IObservable<double> source) => this._source = source;
    ...
    {
      MaxDouble._ obj = new MaxDouble._(observer, cancel);
