...
// Type: System.Reactive.Linq.ObservableImpl.MaxInt32
...
{
  internal class MaxInt32 : Producer<int>
  {
    private readonly IObservable<int> _source;

    public MaxInt32(IObservable<int> source) => this._source = source;
    ...
    {
      MaxInt32._ obj = new MaxInt32._(observer, cancel);
