...
// Type: System.Reactive.Linq.ObservableImpl.MaxInt32Nullable
...
{
  internal class MaxInt32Nullable : Producer<int?>
  {
    private readonly IObservable<int?> _source;

    public MaxInt32Nullable(IObservable<int?> source) => this._source = source;
    ...
    {
      MaxInt32Nullable._ obj = new MaxInt32Nullable._(observer, cancel);
