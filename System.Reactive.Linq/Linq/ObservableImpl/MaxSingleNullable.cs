...
// Type: System.Reactive.Linq.ObservableImpl.MaxSingleNullable
...
{
  internal class MaxSingleNullable : Producer<float?>
  {
    private readonly IObservable<float?> _source;

    public MaxSingleNullable(IObservable<float?> source) => this._source = source;
    ...
    {
      MaxSingleNullable._ obj = new MaxSingleNullable._(observer, cancel);
