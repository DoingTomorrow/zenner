...
// Type: System.Reactive.Linq.ObservableImpl.MinDoubleNullable
...
{
  internal class MinDoubleNullable : Producer<double?>
  {
    private readonly IObservable<double?> _source;

    public MinDoubleNullable(IObservable<double?> source) => this._source = source;
    ...
    {
      MinDoubleNullable._ obj = new MinDoubleNullable._(observer, cancel);
