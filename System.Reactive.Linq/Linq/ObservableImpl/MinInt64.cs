...
// Type: System.Reactive.Linq.ObservableImpl.MinInt64
...
{
  internal class MinInt64 : Producer<long>
  {
    private readonly IObservable<long> _source;

    public MinInt64(IObservable<long> source) => this._source = source;
    ...
    {
      MinInt64._ obj = new MinInt64._(observer, cancel);
