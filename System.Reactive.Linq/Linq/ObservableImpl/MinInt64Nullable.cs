...
// Type: System.Reactive.Linq.ObservableImpl.MinInt64Nullable
...
{
  internal class MinInt64Nullable : Producer<long?>
  {
    private readonly IObservable<long?> _source;

    public MinInt64Nullable(IObservable<long?> source) => this._source = source;
    ...
    {
      MinInt64Nullable._ obj = new MinInt64Nullable._(observer, cancel);
