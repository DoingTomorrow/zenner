...
// Type: System.Reactive.Linq.ObservableImpl.MinSingle
...
{
  internal class MinSingle : Producer<float>
  {
    private readonly IObservable<float> _source;

    public MinSingle(IObservable<float> source) => this._source = source;
    ...
    {
      MinSingle._ obj = new MinSingle._(observer, cancel);
