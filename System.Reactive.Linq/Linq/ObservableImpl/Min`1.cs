...
// Type: System.Reactive.Linq.ObservableImpl.Min`1
...
namespace System.Reactive.Linq.ObservableImpl
{
  internal class Min<TSource> : Producer<TSource>
  {
      ...
      Action<IDisposable> setSink)
    {
      ...
      {
        Min<TSource>._ obj = new Min<TSource>._(this, observer, cancel);
        setSink((IDisposable) obj);
        return this._source.SubscribeSafe<TSource>((IObserver<TSource>) obj);
      }
      Min<TSource>.Delta delta = new Min<TSource>.Delta(this, observer, cancel);
