...
// Type: System.Reactive.Linq.ObservableImpl.Timeout`2
  ...
  internal class Timeout<TSource, TTimeout> : Producer<TSource>
  {
    ...
    private class _ : Sink<TSource>, IObserver<TSource>
    {
      ...
      private void SetTimer(IObservable<TTimeout> timeout)
      {
        ...
        self.Disposable = timeout.SubscribeSafe<TTimeout>((IObserver<TTimeout>) new Timeout<TSource, TTimeout>._.TimeoutImpl(this, id, (IDisposable) self));
      }
      ...
      private class TimeoutImpl : IObserver<TTimeout>
      {
        private readonly Timeout<TSource, TTimeout>._ _parent;
        private readonly ulong _id;
        private readonly IDisposable _self;

        public TimeoutImpl(Timeout<TSource, TTimeout>._ parent, ulong id, IDisposable self)
        {
          this._parent = parent;
          this._id = id;
          this._self = self;
