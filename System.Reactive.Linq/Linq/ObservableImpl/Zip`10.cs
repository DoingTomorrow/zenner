...
// Type: System.Reactive.Linq.ObservableImpl.Zip`10
...
{
  internal class Zip<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> : Producer<TResult>
  {
    ...
    {
      Zip<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>._ obj = new Zip<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>._(this, observer, cancel);
    ...
    private class _ : ZipSink<TResult>
    {
      ...
      public _(
        Zip<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> parent,
        IObserver<TResult> observer,
        IDisposable cancel)
      ...
      {
        IDisposable[] disposableArray = new IDisposable[10];
        ...
        disposableArray[9] = Disposable.Create((Action) (() =>
        {
      ...
      {
        return this._parent._resultSelector(this._observer1.Values.Dequeue(), this._observer2.Values.Dequeue(), this._observer3.Values.Dequeue(), this._observer4.Values.Dequeue(), this._observer5.Values.Dequeue(), this._observer6.Values.Dequeue(), this._observer7.Values.Dequeue(), this._observer8.Values.Dequeue(), this._observer9.Values.Dequeue());
      }
    }
  }
}
