...
// Type: System.Reactive.Linq.ObservableImpl.Zip`13
...
{
  internal class Zip<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> : Producer<TResult>
  {
    ...
    {
      Zip<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>._ obj = new Zip<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>._(this, observer, cancel);
    ...
    private class _ : ZipSink<TResult>
    {
      ...
      public _(
        Zip<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> parent,
        IObserver<TResult> observer,
        IDisposable cancel)
      ...
      {
        IDisposable[] disposableArray = new IDisposable[13];
        ...
        disposableArray[12] = Disposable.Create((Action) (() =>
        {
