...
// Type: System.Reactive.Linq.ObservableImpl.Zip`5
...
namespace System.Reactive.Linq.ObservableImpl
{
  internal class Zip<T1, T2, T3, T4, TResult> : Producer<TResult>
  {
    ...
    private class _ : ZipSink<TResult>
    {
      ...
      {
        IDisposable[] disposableArray = new IDisposable[5];
        ...
        disposableArray[4] = Disposable.Create((Action) (() =>
        {
      ...
      {
        return this._parent._resultSelector(this._observer1.Values.Dequeue(), this._observer2.Values.Dequeue(), this._observer3.Values.Dequeue(), this._observer4.Values.Dequeue());
      }
    }
  }
}
