...
// Type: System.Web.Mvc.ModelClientValidationStringLengthRule
...
namespace System.Web.Mvc
{
  ...
  public class ModelClientValidationStringLengthRule : ModelClientValidationRule
  {
      ...
      int maximumLength)
    {
      ...
      if (minimumLength != 0)
        this.ValidationParameters["min"] = (object) minimumLength;
      if (maximumLength == int.MaxValue)
        return;
      this.ValidationParameters["max"] = (object) maximumLength;
    }
  }
}
