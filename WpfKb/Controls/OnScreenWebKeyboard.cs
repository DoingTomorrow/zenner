...
// Type: WpfKb.Controls.OnScreenWebKeyboard
...
namespace WpfKb.Controls
{
  ...
  {
    public static readonly DependencyProperty AreAnimationsEnabledProperty = DependencyProperty.Register(nameof (AreAnimationsEnabled), typeof (bool), typeof (OnScreenWebKeyboard), (PropertyMetadata) new UIPropertyMetadata((object) true, new PropertyChangedCallback(OnScreenWebKeyboard.OnAreAnimationsEnabledPropertyChanged)));
    public static readonly DependencyProperty KeyBoardInputTypeProperty = DependencyProperty.Register(nameof (KeyBoardInputType), typeof (string), typeof (OnScreenWebKeyboard), (PropertyMetadata) new UIPropertyMetadata((object) "Numeric", new PropertyChangedCallback(OnScreenWebKeyboard.OnInputPropertyChanged)));
    ...
    {
      get => (string) this.GetValue(OnScreenWebKeyboard.KeyBoardInputTypeProperty);
      set => this.SetValue(OnScreenWebKeyboard.KeyBoardInputTypeProperty, (object) value);
    }
    ...
    {
      ((OnScreenWebKeyboard) d).CreateGrid((string) e.NewValue);
    }

    public bool AreAnimationsEnabled
    {
      get => (bool) this.GetValue(OnScreenWebKeyboard.AreAnimationsEnabledProperty);
      set => this.SetValue(OnScreenWebKeyboard.AreAnimationsEnabledProperty, (object) value);
    }
    ...
    private static void OnAreAnimationsEnabledPropertyChanged(
      ...
      DependencyPropertyChangedEventArgs e)
    {
      ((OnScreenWebKeyboard) d)._allOnScreenKeys.ToList<OnScreenKey>().ForEach((Action<OnScreenKey>) (x => x.AreAnimationsEnabled = (bool) e.NewValue));
    }

    [DllImport("user32.dll")]
    private static extern long GetKeyboardLayoutName(StringBuilder pwszKLID);

    private void CreateGrid(string newValue)
    {
      ...
      ObservableCollection<OnScreenKey> source = new ObservableCollection<OnScreenKey>();
      StringBuilder pwszKLID = new StringBuilder("9");
      OnScreenWebKeyboard.GetKeyboardLayoutName(pwszKLID);
      string str = pwszKLID.ToString();
      if (newValue == "AlphaNumeric")
      {
        if (str == "00000407")
        {
          ...
          observableCollection.Add(new OnScreenKey()
          {
            GridRow = 1,
            GridColumn = 11,
            Key = (ILogicalKey) new VirtualKey(VirtualKeyCode.OEM_4, "ß")
          });
          observableCollection.Add(new OnScreenKey()
          {
            GridRow = 1,
          ...
          observableCollection.Add(new OnScreenKey()
          {
            GridRow = 1,
            GridColumn = 13,
            Key = (ILogicalKey) new ShiftSensitiveKey(VirtualKeyCode.OEM_102, (IList<string>) new List<string>()
            {
              "<",
              ">"
            }),
          ...
          observableCollection.Add(new OnScreenKey()
          {
            ...
            GridWidth = new GridLength(7.0, GridUnitType.Star)
          });
          observableCollection.Add(new OnScreenKey()
          {
            GridRow = 4,
            GridColumn = 0,
            Key = (ILogicalKey) new VirtualKey(VirtualKeyCode.MODECHANGE, "123"),
            GridWidth = new GridLength(0.7, GridUnitType.Star)
          });
        ...
        else
        {
          ...
          observableCollection.Add(new OnScreenKey()
          {
            ...
            GridColumn = 1,
            Key = (ILogicalKey) new VirtualKey(VirtualKeyCode.SPACE, " "),
            GridWidth = new GridLength(6.0, GridUnitType.Star)
          });
          observableCollection.Add(new OnScreenKey()
          {
            GridRow = 4,
      ...
      if (newValue == "Numeric")
      {
        ...
        observableCollection.Add(new OnScreenKey()
        {
          GridRow = 0,
          GridColumn = 3,
          Key = (ILogicalKey) new VirtualKey(VirtualKeyCode.BACK, "Backspace")
        });
        observableCollection.Add(new OnScreenKey()
        {
          GridRow = 3,
        ...
        observableCollection.Add(new OnScreenKey()
        {
          GridRow = 1,
          GridColumn = 3,
          Key = (ILogicalKey) new VirtualKey(VirtualKeyCode.DELETE, "Del")
        });
        observableCollection.Add(new OnScreenKey()
        {
          GridRow = 3,
          GridColumn = 0,
          Key = (ILogicalKey) new VirtualKey(VirtualKeyCode.MODECHANGE, "Abc")
        });
        source = observableCollection;
        if (str == "00000407")
          source.Add(new OnScreenKey()
          {
            GridRow = 3,
            GridColumn = 2,
            Key = (ILogicalKey) new ShiftSensitiveKey(VirtualKeyCode.OEM_COMMA, (IList<string>) new List<string>()
